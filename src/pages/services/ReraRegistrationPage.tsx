...
interface ReraRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — RERA Registration in India
const FAQ_ITEMS = [
  { q: 'What is RERA Registration in India?', a: 'RERA Registration is the registration of an eligible real estate project or real estate agent with the applicable State or Union Territory Real Estate Regulatory Authority under the Real Estate (Regulation and Development) Act, 2016 and the relevant state rules.' },
  { q: 'Who needs RERA project registration?', a: 'Promoters of real estate projects covered by the Act must register the project with the applicable RERA authority before advertising, marketing, booking, selling, or offering units for sale, subject to statutory exemptions and state-specific rules.' },
  { q: 'Do real estate agents also need RERA registration?', a: 'Real estate agents who facilitate the sale or purchase of units in registered real estate projects are generally required to obtain RERA agent registration with the applicable authority.' },
  { q: 'What documents are commonly required for RERA project registration?', a: 'Common requirements include promoter and entity details, PAN, project approvals, sanctioned plans, layout plans, land-title and encumbrance details, development or collaboration documents where applicable, project bank-account details, estimated project cost, completion schedule, and declarations/undertakings prescribed by the state authority.' },
  { q: 'How long does RERA registration take?', a: 'Under the central Act, the Authority is required to decide a complete project-registration application within the statutory period, while the practical timeline may vary by state, document completeness, scrutiny, clarification requirements, and payment of prescribed fees.' },
  { q: 'Is the RERA registration fee the same across India?', a: 'No. Application fees, registration charges, renewal charges, and portal requirements are prescribed by the applicable State or Union Territory rules and can vary by project type, area, agent category, and jurisdiction.' }
]

// Related RERA / real-estate compliance services
const RELATED_SERVICES = [
  {
    title: 'RERA Agent Registration',
    desc: 'Registration support for real estate agents and brokers dealing in RERA-registered projects.',
  ...
  },
  {
    ...
    desc: 'End-to-end project registration support for eligible promoters before advertising or selling units.',
    img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'RERA Registration Renewal',
    desc: 'Assistance with eligible renewal or extension applications and supporting compliance documents.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'RERA Quarterly Compliance',
    desc: 'Support for project progress updates, disclosures, document uploads, and periodic RERA compliance.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Property Title Due Diligence',
    desc: 'Review of land-title, ownership, encumbrance, approvals, and supporting property documents.',
    img: 'https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Real Estate Agreement Drafting',
    desc: 'Drafting and review support for agreement for sale, allotment, development, and related documents.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration and compliance support for eligible real estate businesses and service providers.',
    img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Company Registration',
    desc: 'Business incorporation support for real estate developers, consultants, and property-service companies.',
    img: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your real estate brand, project name, logo, and marketing identity with trademark support.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  }
]

export const ReraRegistrationPage: React.FC<ReraRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Real Estate Promoter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('RERA Registration — Contact for Price');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">RERA Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional fee quoted after reviewing your project / agent requirements. Government fee as applicable.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  RERA Registration in India is the regulatory registration process for covered real estate projects and real estate agents under the Real Estate (Regulation and Development) Act, 2016 and the applicable State/UT rules. Project registration is handled by the RERA authority having jurisdiction over the project location.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>State RERA Portal Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Requirement Review Available</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based RERA specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            (as prescribed by State/UT RERA)
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State / UT for RERA Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable authority, forms, fees and documents depend on the State/UT, project location, applicant category and whether you require project or agent registration.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete applicability review, state RERA checklist, document preparation, online filing support, clarification support and post-registration compliance guidance.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Applicant / Entity PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select RERA Registration Service *
                              </label>
                              <select
                              ...
                              >
                                <option value="RERA Registration — Contact for Price">RERA Registration — Contact for Price</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get RERA Consultation</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'comparison', label: 'Compliance Comparison' },
                { id: 'tax-implications', label: 'Financial Compliance' },
                { id: 'financing', label: 'Project Funding' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your RERA Registration Service
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional RERA registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    ...
                    <span className="px-3 py-1 rounded bg-yellow-100 text-yellow-900 text-[10px] font-black uppercase tracking-wide">
                      STATE-SPECIFIC RERA SUPPORT
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#0D47A1]">RERA Registration Support</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Professional support for eligible RERA project or real estate agent registration based on your State/UT authority and filing requirements.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    <p className="text-xs font-bold text-slate-900 uppercase tracking-widest mb-4">SERVICE INCLUSIONS:</p>
                    {[
                      'RERA Applicability & Document Checklist Review',
                      'Promoter / Agent KYC & Entity Document Review',
                      'State RERA Portal Filing Support',
                      'Basic RERA Name Availability Check',
                      'Project Bank Account & Declaration Guidance',
                      'Dedicated RERA Compliance Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('RERA Registration — Contact for Price');
                ...
                >
                  Get Started with RERA Registration Support
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is a RERA in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              RERA registration places covered real estate projects and registered real estate agents within the applicable regulatory framework. For projects, the promoter submits prescribed project, land, approval, finance and timeline disclosures before marketing or sale where registration is mandatory.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for real estate promoters, builders, developers, landowners in development arrangements, and real estate agents or brokers who need registration or compliance support under the applicable RERA rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">State-Specific Filing:</strong>
                  Each State/UT authority prescribes its own online forms, document formats, fee calculation and disclosure requirements under the central Act and local rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Transparent Project Disclosure:</strong>
                  Registered projects are required to make prescribed disclosures relating to approvals, sanctioned plans, promoter details, timelines and project progress through the applicable RERA framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Registration Before Marketing:</strong>
                  Where project registration is mandatory, the promoter must obtain RERA registration before advertising, marketing, booking, selling or offering the project for sale.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Buyer-Fund Discipline:</strong>
                  The Act also imposes financial discipline on promoters, including use of the prescribed separate project account and certification-linked withdrawals for eligible project expenditure.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, RERA registration supports transparent project disclosures, compliant sales activity and accountability in the real estate sector. Our team assists with applicability checks, documents, state portal filing and ongoing compliance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How RERA Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              RERA project registration is a statutory filing by the promoter with the applicable State/UT Real Estate Regulatory Authority. Real estate agents dealing in covered registered projects are also generally required to register under the applicable rules.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the authority issues the relevant registration number or certificate. Registered project details and the RERA registration number must then be used in applicable project disclosures and marketing as prescribed.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk reviews project or agent documentation, prepares the application checklist, assists with state RERA portal filing, and supports replies to authority observations or clarification requests.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'Registration helps covered projects and agents operate within the framework of the Real Estate (Regulation and Development) Act, 2016 and applicable state rules.'
                },
                {
                  title: 'Greater Buyer Transparency',
                  desc: 'Registered projects provide prescribed disclosures on approvals, plans, timelines, promoter details and project progress through the applicable RERA framework.'
                },
                {
                  title: 'Lawful Project Marketing',
                  desc: 'Where registration is mandatory, promoters can advertise, market, book or sell the project only after obtaining the applicable RERA registration.'
                },
                {
                  title: 'Improved Market Credibility',
                  desc: 'A valid RERA registration number helps demonstrate that the project or agent has completed the prescribed regulatory registration process.'
                },
                {
                  title: 'Structured Project Disclosures',
                  desc: 'RERA creates a standardized disclosure and monitoring framework for project information, updates, approvals and commitments.'
                },
                {
                  title: 'Consumer Protection Framework',
                  desc: 'The Act establishes regulatory authorities and adjudicatory mechanisms intended to protect homebuyer interests and improve accountability in real estate.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your RERA
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique RERA Name Selection',
                ...
                },
                {
                  ...
                  desc: 'Identify the real estate project, phase, project type, development structure and location so the correct RERA filing category and jurisdiction can be determined.'
                },
                {
                  title: 'Clearly Defined RERA Objectives and Governance',
                  desc: 'Agree in advance on each promoter / authorized signatory\'s capital contribution and profit/loss sharing ratio to avoid disputes after registration.'
                },
                {
                  title: 'Valid Promoter / Authorized Signatory KYC',
                  desc: 'Ensure each promoter / authorized signatory\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                ...
                {
                  title: 'Compile Project Approvals & Declarations',
                  desc: 'Compile sanctioned plans, layout plans, land/title records, approvals, project timeline, bank details, declarations and other documents prescribed by the State/UT authority.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                RERA Registration Applicability & Eligibility
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              RERA registration applicability depends on the project category, size, phase, location, status and the relevant State/UT rules. Real estate agents facilitating transactions in registered projects are also generally required to obtain agent registration.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Promoters of Covered Real Estate Projects',
                  desc: 'Promoters of projects that fall within the registration requirement must apply to the applicable State/UT RERA authority before permitted marketing or sale.'
                },
                {
                  title: 'Real Estate Agents / Brokers',
                  desc: 'Agents facilitating sale or purchase in registered projects are generally required to obtain RERA agent registration under the applicable rules.'
                },
                {
                  title: 'Project Threshold & Exemption Review',
                  desc: 'Certain small projects and specified categories may be exempt under the Act or state rules; applicability should be checked before filing.'
                },
                {
                  title: 'Valid Promoter / Entity Documentation',
                  desc: 'The applicant must have the prescribed identity, entity, PAN, address, authorization and other KYC documents.'
                },
                {
                  title: 'Project & Land Documentation',
                  desc: 'For project registration, prescribed land-title, approvals, sanctioned plans, project details and declarations must be available.'
                },
                {
                  title: 'State-Specific Rules',
                  desc: 'Forms, fees, document formats, project categories and portal procedures differ by State and Union Territory.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions reviews the available records against the relevant state RERA checklist before application submission.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Commonly Required for RERA Registration
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              RERA documentation varies by jurisdiction and applicant category. Project registration commonly requires promoter/entity KYC, land-title and encumbrance records, approvals, sanctioned plans, project details, financial information, project bank-account details, declarations and professional certificates as prescribed.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Promoter / Entity KYC & PAN',
                  desc: 'PAN, incorporation or constitution proof, registered-office details and authorized-signatory documents of the promoter or applicant.'
                },
                {
                  title: 'Land Title & Encumbrance Documents',
                  desc: 'Title documents, ownership records, encumbrance details and development or collaboration rights, as applicable to the project.'
                },
                {
                  title: 'Sanctioned Plans & Project Approvals',
                  desc: 'Sanctioned plan, layout plan, specifications, development permissions and other approvals prescribed by the competent authority.'
                },
                {
                  title: 'Project Details & Completion Schedule',
                  desc: 'Project description, phase details, inventory, proposed completion timeline and other disclosures required by the applicable RERA portal.'
                },
                {
                  title: 'Financial & Separate Bank Account Details',
                  desc: 'Estimated project cost, funding particulars, project bank-account information and prescribed financial declarations or certificates.'
                },
                {
                  title: 'Declarations, Undertakings & Professional Certificates',
                  desc: 'Affidavits, declarations, undertakings and certificates from architect, engineer, chartered accountant or other professionals where prescribed.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  step: 'Step 1',
                  title: 'RERA Applicability & Jurisdiction Check',
                  desc: 'We identify whether you need project or agent registration and confirm the applicable State/UT RERA authority and filing category.'
                },
                {
                  step: 'Step 2',
                  title: 'Document & KYC Collection',
                  desc: 'Collect promoter or agent KYC, entity documents, land/title records, approvals, plans, financial information and other prescribed records.'
                },
                {
                  step: 'Step 3',
                  title: 'Application Data & Disclosure Preparation',
                  desc: 'Organize the project, promoter, timeline, inventory, approval and financial details required by the state RERA application.'
                },
                {
                  step: 'Step 4',
                  title: 'State RERA Portal Filing',
                  desc: 'Prepare and submit the online application with supporting documents and prescribed statutory fee on the applicable portal.'
                },
                {
                  step: 'Step 5',
                  title: 'Authority Scrutiny & Clarification Support',
                  desc: 'Assist with observations, defect notices, document corrections or clarification requests raised during scrutiny.'
                },
                {
                  step: 'Step 6',
                  title: 'Registration Number & Compliance Guidance',
                  desc: 'After approval, obtain the registration details and guidance on permitted marketing disclosures, updates, renewals/extensions and ongoing compliance.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  RERA registration is a regulatory approval or registration and does not itself create a new legal entity. The promoter or agent continues to operate through its existing proprietorship, partnership, LLP, company or other lawful business structure.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the RERA structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a promoter / authorized signatory\'s exit, unless the deed states otherwise.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The promoter, authorized persons and real estate agents remain responsible for compliance with the Act, state rules, registration conditions and representations made to allottees.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance advisors guide you on project or agent registration, required disclosures, state-specific documents, portal filing and ongoing RERA obligations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, promoters and agents must comply with continuing obligations prescribed by the Act, applicable state rules and the conditions of registration.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Registration Details & Portal Profile Maintenance',
                  desc: 'Apply for a Permanent Account Number (PAN) in the RERA\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Project Bank Account Compliance',
                  desc: 'Open a dedicated bank account in the registered RERA name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual RERA Compliance & Tax Filing',
                  desc: 'File the RERA\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Material Project / Promoter Changes',
                  desc: 'Update material changes in promoter details, approvals, project plans, timelines or other registered particulars as permitted and required.'
                },
                {
                  title: 'Advertisement & Sales Disclosure Compliance',
                  desc: 'Use the RERA registration number and required project disclosures in advertisements, marketing and sale communications as applicable.'
                },
                {
                  title: 'Extension / Renewal / Completion Filings',
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the RERA employs staff.'
                },
                {
                  title: 'akshayb2bsolutions RERA Compliance Support',
                  desc: 'Our team can assist with compliance calendars, project updates, document uploads and state RERA filing support.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                RERA vs Other Business Structures
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Promoter / Project Based
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">Entity / Applicant Based</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on RERA structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Individual / Proprietor Businesses</td>
                    <td className="p-3.5 border-r border-slate-200">LLP / Partnership Businesses</td>
                    <td className="p-3.5">Companies / Corporate Developers</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for RERAs in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              RERA registration does not replace the applicant's normal tax and accounting obligations. Promoters and agents must separately comply with GST, income-tax, TDS and other financial requirements applicable to their business and transactions.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on RERA Structure',
                  desc: 'Tax treatment depends on the promoter or agent\'s legal entity, transaction type and applicable tax law; RERA registration itself is a regulatory registration.'
                },
                {
                  title: 'Project Accounting & Financial Records',
                  desc: 'Maintain project-wise financial records, invoices, receipts, statutory certificates and bank documentation required for tax and RERA compliance.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working promoter / authorized persons are taxable in the promoter / authorized signatory\'s hands but deductible for the RERA, subject to prescribed limits.'
                },
                {
                  title: 'GST Threshold Exemption Limits',
                  desc: 'GST registration remains optional until annual turnover crosses prescribed threshold for goods suppliers (applicable threshold for special category states) and applicable threshold for service providers.'
                },
                {
                  title: 'Mandatory Tax Audit Above Turnover Limits',
                  desc: 'Eligible RERAs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the RERA structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Real estate projects may be funded through promoter equity, institutional finance, customer collections and other lawful sources. RERA imposes project-fund discipline and disclosure obligations intended to reduce diversion of buyer funds.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Promoter Equity & Internal Accruals',
                  desc: 'Promoters may deploy equity or internal accruals for land, approvals, construction and other eligible project costs.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, RERAs may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an RERA; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your promoter / authorized persons\' needs.'
                },
                {
                  title: 'Project Document Review & Digital Filing',
                  desc: 'Our compliance specialists organize the prescribed RERA documents, declarations and portal data to reduce avoidable filing defects.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Get continued support for RERA updates, extensions/renewals where applicable, compliance calendars and document follow-up.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Real Estate Businesses Choose akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Requirement-based professional quotation with applicable State/UT RERA statutory fees communicated separately.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your promoter / authorized persons\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your RERA with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional RERA registration assistance for project or agent filings across applicable Indian State/UT portals, with a clear document checklist and requirement-based quotation.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Request RERA Registration Quote
              </button>
              <button
