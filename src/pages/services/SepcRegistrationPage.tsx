...
interface SepcRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian SEPC Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is Services Export Promotion Council (SEPC) Registration?', a: 'SEPC Registration generally refers to membership / Registration-Cum-Membership Certificate (RCMC) with the Services Export Promotion Council for eligible service exporters in India.' },
  { q: 'Who should apply for SEPC RCMC?', a: 'Eligible service exporters in sectors covered by SEPC can apply, including IT/ITES, consultancy, education, healthcare, travel, tourism, logistics and other professional or business services, subject to current SEPC and DGFT requirements.' },
  { q: 'What are the benefits of SEPC membership?', a: 'SEPC members can access trade leads, market-access opportunities, export promotion and development support, policy representation, advisory services and selected certificates or schemes subject to prevailing rules.' },
  { q: 'How is SEPC RCMC applied for?', a: 'SEPC RCMC is applied for through the DGFT e-RCMC platform. Applicants generally require an active IEC, updated DGFT profile and valid DSC or Aadhaar e-Sign.' },
  { q: 'What documents are commonly required?', a: 'The exact checklist depends on the membership category, but commonly includes IEC-linked details, PAN/entity information, turnover and foreign exchange earnings information, service-export profile, signatory details and supporting documents.' },
  { q: 'Is SEPC Registration fee fixed?', a: 'No. SEPC membership fees vary by turnover slab and membership category. We provide a custom quotation after reviewing your business profile and support requirements.' }
]

// Related services cross-linking items — sourced from SEPC-adjacent structures
const RELATED_SERVICES = [
  { title: 'IEC Registration', desc: 'IEC registration support for Indian service businesses planning to export services and receive international payments.', img: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'RCMC Registration', desc: 'RCMC registration support through the appropriate Export Promotion Council or registering authority.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'GST Registration', desc: 'GST registration and compliance support for IT, consulting, education, healthcare and other service exporters.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'LUT Filing', desc: 'LUT filing support for eligible exporters supplying services without payment of IGST.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'Trademark Registration', desc: 'Protect your service brand before expanding to international clients and markets.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible service exporters, startups and MSMEs.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'Startup India Registration', desc: 'DPIIT Startup India recognition support for eligible export-focused service startups.', img: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'Export Documentation Support', desc: 'Support for service-export documentation, foreign remittance records and compliance coordination.', img: 'https://images.unsplash.com/photo-1494412685616-a5d310fbb07d?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' },
  { title: 'Service Export Compliance Consultation', desc: 'Combined roadmap for IEC, SEPC RCMC, GST, LUT and service-export readiness.', img: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&auto=format&fit=crop&q=80', price: 'Contact Contact for Price' }
]

export const SepcRegistrationPage: React.FC<SepcRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Service Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('SEPC RCMC Registration Support — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Services Export Promotion Council (SEPC) Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-white leading-tight antialiased">
                    Services Export Promotion Council (SEPC) Registration
                  </h1>
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Grow your service exports with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Custom quote after exporter-profile review
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Services Export Promotion Council (SEPC) Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an SEPC may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <BriefcaseBusiness className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Service Exporter Focused</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Laptop2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Exporter Document Review</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Zap className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Digital RCMC Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Globe2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>DGFT / SEPC Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <PlaneTakeoff className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Free Exporter Eligibility Check</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based SEPC / RCMC specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Your State / Service Business Location *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable registration authority and documentation depend on whether your SEPC is formed as a Society, Trust, or Section 8 Company.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete SEPC name-check, MOA / Trust Deed / Society Rules drafting, government filing support, and registration guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select SEPC Registration Support *
                              </label>
                              <select
                              ...
                              >
                                <option value="Services Export Promotion Council (SEPC) Registration Package (Contact for Price)">Services Export Promotion Council (SEPC) Registration Package — Contact for Price + SEPC / Statutory Chargess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get SEPC Quote</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Service Export Growth Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your SEPC Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional SEPC registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      SERVICE EXPORTER GROWTH PACKAGE
                    </span>
                    <span className="px-3 py-1 rounded bg-yellow-100 text-yellow-900 text-[10px] font-black uppercase tracking-wide">
                      CUSTOM QUOTE AFTER PROFILE REVIEW
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#0D47A1]">SEPC Export Growth Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    For eligible service exporters who want SEPC / RCMC support plus a practical checklist for the next export-compliance and market-access steps.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'SEPC / RCMC Eligibility & Profile Review',
                      'IEC & DGFT Profile Readiness Check',
                      'DGFT / SEPC Filing Support',
                      'Basic SEPC Name Availability Check',
                      'Turnover / Foreign Exchange Documentation Check',
                      'Dedicated SEPC Registration Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Services Export Promotion Council (SEPC) Registration Package (Contact for Price)');
                ...
                >
                  Get Started with SEPC Export Growth Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Service Export Overview
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is a SEPC in India?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              SEPC registration gives a non-governmental organization a recognized legal identity to operate for lawful charitable or social-welfare objectives. The organization may be structured as a Society, Trust, or Section 8 Company, with its governing documents defining its purpose, members or trustees, management, and rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  IT/ITES companies, consultants, professional service firms, education providers, healthcare businesses, travel and tourism companies, logistics firms and other eligible service exporters.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Access Market Opportunities:</strong>
                  Properly drafted MOA, Trust Deed, or Society Rules clearly define the SEPC's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">RCMC Through DGFT:</strong>
                  The legal identity and liability framework depends on whether the SEPC is formed as a Society, Trust, or Section 8 Company; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Export Scheme & Certificate Support:</strong>
                  Registration under the Indian SEPC Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow members / trustees in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Build International Credibility:</strong>
                  An SEPC is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, SEPC registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Services Export Promotion Council (SEPC) Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              SEPC registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the SEPC registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of a SEPC
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Trade Leads & Market Access', desc: 'SEPC members can access authentic trade leads and market-access opportunities across existing and emerging international markets.' },
                { title: 'Export Development & Promotion Support', desc: 'SEPC supports service exporters through export-development and promotional initiatives designed to improve international business opportunities.' },
                { title: 'Policy & Government Representation', desc: 'SEPC acts as a platform between Government and industry to raise exporter issues, provide policy inputs and share market insights.' },
                { title: 'Advisory Support for Exporters', desc: 'Members can access advisory support in areas such as GST, income tax, customs and Foreign Trade Policy, subject to prevailing member services.' },
                { title: 'Eligibility for Selected Schemes & Certificates', desc: 'Eligible members can use SEPC support for certain ministry schemes and exporter certificates depending on applicable rules.' },
                { title: 'Build a Stronger Export Profile', desc: 'After obtaining RCMC, members can build their company profile under MY SEPC and improve visibility within the service-export ecosystem.' }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Registering Your SEPC
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique SEPC Name Selection',
                ...
                {
                  title: 'Clearly Defined SEPC Objectives and Governance',
                ...
                },
                {
                  ...
                  desc: 'Clearly state the SEPC objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                SEPC Registration Eligibility
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a SEPC in India, there must be a minimum of two members / trustees and a maximum of twenty. All members / trustees must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen SEPC structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected SEPC structure.'
                },
                {
                  title: 'Unique SEPC Name Requirement',
                  desc: 'The SEPC must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written SEPC Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the SEPC objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The SEPC must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a SEPC.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Commonly Required for SEPC / RCMC
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your SEPC registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'The applicable governing document signed/executed by the required founders, trustees, members, or directors, covering SEPC objectives and governance rules.'
                },
                {
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step SEPC / RCMC Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft MOA / Trust Deed / Society Rules',
                  desc: 'We prepare the appropriate governing document detailing the SEPC objectives, founders/trustees, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique SEPC Name',
                  desc: 'Our team helps check the proposed SEPC name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped SEPC deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'IEC & DGFT Profile Readiness Check & GST Registration',
                  desc: 'We apply for the SEPC\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the SEPC registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the SEPC bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an SEPC depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the SEPC structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate SEPC structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, SEPCs must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the SEPC\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered SEPC name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual SEPC Compliance & Tax Filing',
                  desc: 'File the SEPC\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the SEPC employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                SEPC vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on SEPC structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for SEPCs in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              SEPC tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on SEPC Structure',
                  desc: 'Tax liability and exemptions depend on whether the SEPC is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible SEPCs must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / trustees are taxable in the founder / trustee\'s hands but deductible for the SEPC, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible SEPCs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the SEPC structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              SEPCs generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible SEPCs may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, SEPCs may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                  title: 'Pradhan Mantri MUDRA Yojana (PMMY)',
                  desc: 'Obtain collateral-free micro loans up to Contact Contact for Price Lakhs across Shishu, Kishore, and Tarun categories for non-corporate micro enterprises.'
                },
                {
                  title: 'Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE)',
                  desc: 'Avail credit guarantees for collateral-free business loans up to Contact Contact for Price–5 Crore from scheduled commercial banks.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an SEPC; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound SEPC deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your SEPC with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their SEPC with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
