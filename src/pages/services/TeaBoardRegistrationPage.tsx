...
interface TeaBoardRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Tea Act, 1953 / applicable Tea Board control orders framework)
const FAQ_ITEMS = [
  { q: 'What is Tea Board Export Promotion Council registration?', a: 'For tea exporters, the key registrations are the Tea Board Exporter Licence and the Registration-cum-Membership Certificate (RCMC). RCMC supports recognition under India\'s Foreign Trade Policy and is used by eligible tea exporters for export-related entitlements and benefits.' },
  { q: 'Who should apply for Tea Board RCMC?', a: 'Merchant exporters and manufacturer exporters dealing in bulk tea, packet tea, tea bags, instant tea or other eligible tea export categories may need Tea Board registration and RCMC, subject to the applicable Tea Board and Foreign Trade Policy requirements.' },
  { q: 'Is an IEC required before applying?', a: 'Yes. A valid Importer Exporter Code (IEC) is generally a key prerequisite for exporters. The applicant details, IEC and Tea Board exporter-licence information should be consistent before the RCMC application is filed.' },
  { q: 'Where is Tea Board e-RCMC applied for?', a: 'Tea Board e-RCMC applications and renewals are filed through the DGFT common e-RCMC portal. Our service focuses on eligibility review, document preparation, filing support and clarification handling.' },
  { q: 'How long is Tea Board RCMC valid?', a: 'Tea Board has stated that RCMC is issued for the prescribed Foreign Trade Policy validity period, subject to the validity of the exporter licence. Renewal should be planned before expiry to avoid export-documentation disruptions.' },
  { q: 'What happens after registration?', a: 'Exporters should maintain their Tea Board licence/RCMC details, comply with applicable export returns and quality requirements, keep IEC/GST/bank details updated and monitor Tea Board or DGFT notices affecting tea exports.' }
]

// Related services cross-linking items — sourced from Tea Exporter-adjacent structures
const RELATED_SERVICES = [
  { title: 'IEC Registration', desc: 'Get or update your Importer Exporter Code before starting tea export registrations and customs formalities.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'APEDA Registration', desc: 'RCMC support for eligible agricultural and processed-food export products handled under APEDA.', img: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'Spices Board CRES', desc: 'Registration support for exporters dealing in spices and spice products from India.', img: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'ICEGATE Registration', desc: 'Set up customs portal access for import-export filings and electronic customs services.', img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'AD Code Registration', desc: 'Support for registering your bank AD Code for export customs processing at the relevant port.', img: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'Certificate of Origin', desc: 'Assistance with origin documentation for eligible export shipments and buyer-country requirements.', img: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'FSSAI Registration', desc: 'Food-business licensing support for eligible tea packing, processing and food-related operations.', img: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'GST & LUT Support', desc: 'GST registration and LUT guidance for eligible exporters making zero-rated supplies without IGST payment.', img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'Trademark Registration', desc: 'Protect your tea brand, logo and export-facing identity in India through trademark filing support.', img: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' }
]

export const TeaBoardRegistrationPage: React.FC<TeaBoardRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Tea Exporter');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Tea Export Growth Package — Custom Quote');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Tea Board Export Promotion Council</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                {/* Location & Exporter Business Pill */}
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start your tea export compliance with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Custom Quote (as applicable, paid separately)
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Tea Board export registration helps Indian tea exporters obtain the registrations needed to operate within the Tea Board and Foreign Trade Policy framework. Depending on the business model, exporters may require a Tea Board Exporter Licence and RCMC before claiming applicable export benefits or completing buyer and regulatory requirements.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Guided Filing Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Briefcase className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Merchant / Manufacturer Exporters</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileCheck className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Exporter Licence & RCMC Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Tea Board / DGFT Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-white/10 border border-white/15 text-xs text-white">
                    ...
                    <span className="text-slate-300 text-[11px]">Exporter Businesspilot</span>
                  </div>
                </div>
              </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based Tea export compliance specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            based on your exporter profile
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Tea Export Business *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable registration authority and documentation depend on whether your Tea Exporter is formed as a Exporter Entity, Exporter Business, or Company Exporter.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete Tea Exporter name-check, MOA / Exporter Business Deed / Exporter Entity Rules drafting, government filing support, and registration guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Tea Board Export Promotion Council Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Tea Board Export Promotion Council Package (Quote)">Tea Board Export Promotion Council Package — Quote Custom Quotes</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Check Tea Export Eligibility</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'legal-status', label: 'Regulatory Status' },
                { id: 'post-compliance', label: 'Post-Registration' },
                { id: 'comparison', label: 'Registration Comparison' },
                { id: 'tax-implications', label: 'Export Tax & GST' },
                { id: 'financing', label: 'Export Benefits' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Exporter-Focused Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your Tea Export Growth Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional Tea Exporter registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Tea Export Growth Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    A conversion-focused compliance package for businesses planning to export Indian tea with the right licence, RCMC and supporting export registrations.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-lg text-slate-400 line-through">Custom</span>
                      <span className="text-4xl font-extrabold text-[#0D47A1]">Quote</span>
                    </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'MOA / Exporter Business Deed / Exporter Entity Rules Drafting & Vetting',
                      'IEC, PAN & Business Detail Consistency Check',
                      'Tea Board / DGFT Filing Support',
                      'Basic Tea Exporter Name Availability Check',
                      'Export Bank, GST & AD Code Readiness Guidance',
                      'Dedicated Tea Export Compliance Specialist'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Tea Board Export Promotion Council Package (Quote)');
                ...
                >
                  Get Started with Tea Export Growth Package
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Tea Board Export Promotion Council Registration?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Tea Board registration creates a recognised compliance pathway for businesses exporting bulk tea, packet tea, tea bags, instant tea and other eligible tea products. A properly aligned IEC, Tea Board exporter licence and RCMC can help reduce documentation gaps when working with customs, banks, overseas buyers and export-benefit processes.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for export organizations, trade promotion initiatives, educational and healthcare projects, international trade organizations, foundations, and other export initiatives seeking a legally recognized structure.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, Exporter Business Deed, or Exporter Entity Rules clearly define the Tea Exporter's objectives, governance, membership or exportership, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the Tea Exporter is formed as a Exporter Entity, Exporter Business, or Company Exporter; the governing documents and applicable law determine the responsibilities of members, exporters, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian Tea Exporter Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow members / exporters in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An Tea Exporter is not formed for distributing profits to members. Eligible organizations can pursue export proceeds, export incentives, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Tea Exporter registration provides a recognized legal framework for pursuing export and export objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Tea Board Export Promotion Council Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Tea Exporter registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Exporter Entity, Exporter Business, or Company Exporter.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the exporter can maintain the licence and RCMC as part of its export-compliance file. These registrations support recognised exporter status and may be relevant for Foreign Trade Policy benefits, banking documentation and export transactions, subject to applicable rules.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our legal desk helps prepare the appropriate MOA, Exporter Business Deed, Exporter Entity Rules, declarations, and supporting documents and assists with filing and government follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Benefits of Tea Board Export Registration
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Legal recognition helps the Tea Exporter operate through a defined legal structure, enter agreements, maintain records, and pursue its stated export or export objectives.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'Exporters pool resources, skills, and networks, enabling faster growth than a single-owner structure with minimal capital constraints.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on Tea Exporter structure, state, authority, and government verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible Tea Exporters may access government schemes, export incentives, CSR opportunities, and buyer programs subject to the relevant eligibility and compliance requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tea Export Readiness Checklist
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique Tea Exporter Name Selection',
                ...
                {
                  title: 'Clearly Defined Tea Exporter Objectives and Governance',
                  desc: 'Agree in advance on each exporter\'s capital contribution and profit/loss sharing ratio to avoid disputes after registration.'
                },
                {
                  title: 'Valid Identity and Address Proofs of All Exporters',
                  desc: 'Ensure each exporter\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                ...
                {
                  title: 'Draft MOA / Exporter Business Deed / Exporter Entity Rules',
                  desc: 'Clearly state the Tea Exporter objectives, governance, membership or exportership, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Tea Board Export Promotion Council
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a Tea Exporter in India, there must be a minimum of two members / exporters and a maximum of twenty. All members / exporters must be competent to contract under the Foreign Trade Policy, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Exporters',
                  desc: 'The minimum founders, members, exporters, or directors depend on the chosen Tea Exporter structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, exporters, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected Tea Exporter structure.'
                },
                {
                  title: 'Unique Tea Exporter Name Requirement',
                  desc: 'The Tea Exporter must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written Tea Exporter Deed',
                  desc: 'The appropriate MOA, Exporter Business Deed, or Exporter Entity Rules must clearly state the Tea Exporter objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The Tea Exporter must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a Tea Exporter.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each exporter\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Tea Board Export Promotion Council
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your Tea Exporter registration smoothly, identity and address proofs of founders, exporters, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Exporters\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each exporter\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Exporters\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Accepted identity and address proof such as Aadhaar, Voter ID, Passport, or other applicable documents for founders, exporters, members, or directors.'
                },
                {
                ...
                {
                  title: 'Signed MOA / Exporter Business Deed / Exporter Entity Rules',
                  desc: 'The applicable governing document signed/executed by the required founders, exporters, members, or directors, covering Tea Exporter objectives and governance rules.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our legal drafting team prepares the applicable MOA, Exporter Business Deed, Exporter Entity Rules, NOC drafts, declarations, and supporting documents according to the relevant authority requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Tea Board Export Promotion Council Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft MOA / Exporter Business Deed / Exporter Entity Rules',
                  desc: 'We prepare the appropriate governing document detailing the Tea Exporter objectives, founders/exporters, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Exporters',
                  desc: 'Upload PAN, identity/address proof, registered-office proof, NOC where required, and photographs of the required founders, exporters, members, or directors.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique Tea Exporter Name',
                  desc: 'Our team helps check the proposed Tea Exporter name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped Tea Exporter deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the Tea Exporter\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the Tea Exporter registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the Tea Exporter bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Regulatory Status of a Registered Tea Exporter
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an Tea Exporter depends on its structure. A Company Exporter has a separate corporate identity, while Exporter Entity and Exporter Business structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the Tea Exporter structure and activities and may include annual returns, accounts, tax filings, renewal/updates, buyer records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a exporter\'s exit, unless the deed states otherwise.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The responsibilities and liability of members, exporters, directors, and office bearers depend on the selected legal structure and applicable law.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate Tea Exporter structure, governing documents, tax registrations, buyer-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, Tea Exporters must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the Tea Exporter\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered tea exporter name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual Tea Exporter Compliance & Tax Filing',
                  desc: 'File the Tea Exporter\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Report applicable changes to governing documents, exporters, directors, registered office, or other particulars to the relevant authority.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the Tea Exporter employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tea Board Registration vs Other Export Registrations
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Tea Act, 1953 / applicable Tea Board control orders
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Exporters</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on Tea Exporter structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">7. Credibility &amp; Exporter Business</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Social Welfare &amp; Export Organizations</td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for Tea Exporters in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Tea Exporter tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible export organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on Exporter Type',
                  desc: 'Tax liability and exemptions depend on whether the Tea Exporter is a Exporter Business, Exporter Entity, or Company Exporter and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible Tea Exporters must apply income according to their export objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working members / exporters are taxable in the exporter\'s hands but deductible for the Tea Exporter, subject to prescribed limits.'
                },
                {
                  title: 'GST Threshold Exemption Limits',
                  desc: 'GST registration remains optional until annual turnover crosses Custom Quote Lakhs for goods suppliers (Custom Quote Lakhs for special category states) and Custom Quote Lakhs for service providers.'
                },
                {
                  title: 'Mandatory Tax Audit Above Turnover Limits',
                  desc: 'Eligible Tea Exporters should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the Tea Exporter structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Tea Exporters generally rely on export proceeds, export incentives, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible Tea Exporters may receive export proceeds, export incentives, and institutional support subject to applicable law, buyer conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, Tea Exporters may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                  title: 'Pradhan Mantri MUDRA Yojana (PMMY)',
                  desc: 'Obtain collateral-free micro loans up to Custom Quote Lakhs across Shishu, Kishore, and Tarun categories for non-corporate micro enterprises.'
                },
                {
                  title: 'Credit Guarantee Fund Exporter Business for Micro and Small Enterprises (CGTMSE)',
                  desc: 'Avail credit guarantees for collateral-free business loans up to Custom Quote–5 Crore from scheduled commercial banks.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an Tea Exporter; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your members / exporters\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound Tea Exporter deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Thousands of Co-Founders Exporter Business akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden costs, crystal-clear pricing starting at just Quote/-, and transparent separate government fee breakdowns.',
                  icon: Tag
                },
                {
                  title: 'Exporter Businessed by Thousands',
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your members / exporters\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your Tea Exporter with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their Tea Exporter with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
