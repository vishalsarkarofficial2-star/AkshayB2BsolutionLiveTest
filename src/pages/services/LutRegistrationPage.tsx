...
interface LutRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — LUT Registration under GST
const FAQ_ITEMS = [
  { q: 'What is LUT Registration under GST?', a: 'A Letter of Undertaking (LUT) allows eligible GST-registered exporters to export goods or services, or make eligible zero-rated supplies to SEZ, without payment of Integrated GST, subject to GST law and prescribed conditions.' },
  { q: 'Which form is used for LUT filing?', a: 'LUT is furnished electronically in FORM GST RFD-11 on the GST portal for the relevant financial year.' },
  { q: 'Who can apply for LUT Registration?', a: 'Generally, GST-registered persons intending to make zero-rated supplies without payment of IGST can furnish LUT, except persons restricted by the applicable prosecution and tax-evasion conditions under GST rules.' },
  { q: 'How long is an LUT valid?', a: 'An accepted LUT is valid for the financial year in which it is furnished. A fresh LUT is normally required for each new financial year.' },
  { q: 'What documents are generally required for LUT filing?', a: 'Common requirements include GST registration details, PAN and KYC of the authorized signatory, authorization or board resolution where applicable, previous LUT details if any, and exporter/business information.' },
  { q: 'Is LUT useful for service exporters and exporters of goods?', a: 'Yes. Eligible registered exporters of goods or services can use LUT to make zero-rated supplies without upfront payment of IGST, subject to the applicable GST conditions and export timelines.' }
];

// Related GST & export compliance services
const RELATED_SERVICES = [
  { title: 'GST Registration', desc: 'Get GST registration support for businesses, exporters and service providers across India.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: '₹999' },
  { title: 'GST Return Filing', desc: 'Professional GSTR filing and periodic GST compliance support for registered businesses.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'IEC Registration', desc: 'Import Export Code registration support for businesses engaged in international trade.', img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'ICEGATE Registration', desc: 'ICEGATE registration assistance for customs-related online services and exporter access.', img: 'https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=600&auto=format&fit=crop&q=80', price: '₹1,999' },
  { title: 'AD Code Registration', desc: 'AD Code registration assistance for exporters to link banking details with customs ports.', img: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&auto=format&fit=crop&q=80', price: '₹3,500' },
  { title: 'GST Refund Assistance', desc: 'Support for eligible GST refund applications relating to exports and zero-rated supplies.', img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Export Documentation Support', desc: 'Assistance with export invoices, declarations and compliance documentation for international trade.', img: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible micro, small and medium enterprises in India.', img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop&q=80', price: '₹999' },
  { title: 'Trademark Registration', desc: 'Protect your business name, logo and brand identity through trademark filing support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
];

export const LutRegistrationPage: React.FC<LutRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('LUT Registration Package (₹999 + Govt. Fees)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">LUT Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  LUT Registration under GST enables eligible registered exporters to make zero-rated supplies of goods or services without payment of IGST. It is filed in FORM GST RFD-11 on the GST portal and is generally valid for the relevant financial year.
                </p>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our GST LUT specialist has been assigned to your registration docket. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your GST registration state/UT and GSTIN details are used for LUT filing and jurisdictional compliance.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete LUT eligibility review, GST RFD-11 preparation, GST portal filing support and acknowledgement guidance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select LUT Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="LUT Registration Package (₹999 + Govt. Fees)">LUT Registration Package — ₹999 + Govt. Fees</option>
                              </select>
                            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your LUT Registration Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes LUT eligibility review, FORM GST RFD-11 preparation, GST portal filing support and dedicated GST compliance assistance.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    Essential LUT filing support for eligible GST-registered exporters making zero-rated supplies without payment of IGST.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'FORM GST RFD-11 Preparation & Review',
                      'GSTIN & Authorized Signatory Verification',
                      'GST Portal LUT Filing Support',
                      'LUT Eligibility & Previous Filing Check',
                      'Export / Zero-Rated Supply Compliance Guidance',
                      'Dedicated GST Compliance Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('LUT Registration Package (₹999 + Govt. Fees)');
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is LUT Registration under GST?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Letter of Undertaking (LUT) is an undertaking furnished by an eligible GST-registered exporter to make zero-rated supplies without payment of IGST. It reduces the need to pay IGST upfront and subsequently claim refund, subject to compliance with GST export conditions.
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A properly filed LUT records the exporter’s undertaking to comply with GST conditions for zero-rated supplies without payment of IGST.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  LUT does not create a new legal entity; it operates within the existing GST registration of the exporter and is linked to the registered person’s GSTIN.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  LUT is relevant when an eligible exporter chooses to make zero-rated supplies without upfront payment of IGST, subject to the conditions prescribed under GST law.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Using LUT can improve cash-flow efficiency by avoiding upfront IGST payment on eligible zero-rated supplies, while the exporter continues to follow return filing and export realization requirements.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, LUT filing is a GST compliance facility for eligible exporters. Our team supports eligibility review, RFD-11 preparation, online filing and post-filing guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How LUT Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              LUT filing is completed electronically on the GST portal in FORM GST RFD-11. The applicant provides GST registration details, authorized signatory information and the prescribed undertaking for making eligible zero-rated supplies without payment of IGST.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful filing, the LUT acknowledgement/reference can be used for eligible exports during the relevant financial year, subject to compliance with export realization, reporting and other GST requirements.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our GST desk reviews eligibility, prepares FORM GST RFD-11 details, assists with online filing and helps resolve common portal or documentation issues.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of LUT Registration
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'LUT allows eligible zero-rated supplies without upfront payment of IGST, helping reduce working-capital blockage.'
                },
                {
                  title: 'Shared Capital & Combined Expertise',
                  desc: 'The LUT is filed online against the GSTIN and can support both eligible goods and service exporters.'
                },
                {
                  title: 'Minimal Start-up Costs & Quick Setup',
                  desc: 'Online filing is comparatively simple when GST profile, signatory and export details are ready and accurate.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible exporters can use LUT for zero-rated supplies to overseas customers and qualifying SEZ supplies, subject to GST rules.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Filing Your LUT
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Confirm the GST registration is active and the GSTIN details match the exporter applying for LUT.'
                },
                {
                  title: 'Clear Commercial Business Activity Identification',
                  desc: 'Identify whether your proposed supplies qualify as exports or zero-rated supplies and keep invoice and HSN/SAC details ready.'
                },
                {
                  title: 'Export / Zero-Rated Supply Details',
                  desc: 'Keep export or zero-rated supply details ready, including the nature of goods/services and expected supply route.'
                },
                {
                  title: 'Authorized Signatory KYC',
                  desc: 'Ensure the authorized signatory’s PAN, mobile number, email and GST portal access are current for authentication and filing.'
                },
                {
                  title: 'GST Registered Business Details',
                  desc: 'Keep principal place of business and GST registration particulars current and consistent with the GST portal.'
                },
                {
                  title: 'Prepare FORM GST RFD-11 Details',
                  desc: 'Review the prescribed undertaking, GSTIN, financial year and signatory details before submitting FORM GST RFD-11.'
                },
                {
                  title: 'Export Compliance Readiness',
                  desc: 'Keep IEC, export invoice, banking and other trade-compliance details ready where applicable to your export activity.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To furnish an LUT, the applicant should be a GST-registered person intending to make eligible zero-rated supplies without payment of IGST and should satisfy the conditions prescribed under GST law.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The applicant should hold an active GSTIN and intend to make eligible zero-rated supplies.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'The authorized signatory should be validly recorded on the GST registration and authorized to furnish the undertaking.'
                },
                {
                  title: 'Eligible LUT Applicant',
                  desc: 'The applicant must satisfy the prevailing LUT eligibility conditions, including applicable prosecution and tax-evasion restrictions.'
                },
                {
                  title: 'FORM GST RFD-11 Undertaking',
                  desc: 'The prescribed undertaking must be furnished electronically for the relevant financial year before making eligible zero-rated supplies without IGST payment.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'GST registration particulars, principal place of business and jurisdictional details should be current and accurate.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'The underlying supply must satisfy GST requirements for export or other eligible zero-rated supply treatment.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions reviews GSTIN, authorized signatory details and LUT eligibility before filing to reduce avoidable errors.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              For smooth LUT filing, keep GST registration details, authorized signatory KYC, authorization documents where applicable, previous LUT details and basic export information ready. Documents can be shared digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'GST Registration Certificate / GSTIN Details',
                  desc: 'Active GSTIN and GST registration details of the exporter for whom the LUT is being furnished.'
                },
                {
                  title: 'Authorized Signatory PAN / KYC',
                  desc: 'PAN and basic KYC/contact details of the authorized signatory responsible for the GST portal filing.'
                },
                {
                  title: 'GST Registration / Principal Place Details',
                  desc: 'Current GST registration particulars and principal place of business details for verification, where required.'
                },
                {
                  title: 'Previous LUT Details, if any',
                  desc: 'Copy or acknowledgement details of the previous financial year’s LUT, if already filed, for reference.'
                },
                {
                  title: 'Authorization / Board Resolution, if applicable',
                  desc: 'Authorization letter or board resolution may be kept ready where required based on the constitution and signatory arrangement.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our GST team organizes LUT details and supporting documents in the format required for efficient online filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step LUT Registration Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Prepare FORM GST RFD-11 Details',
                  desc: 'We verify the GST registration, authorized signatory details and basic eligibility for LUT filing.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect GST & Signatory Documents',
                  desc: 'Share GSTIN details, signatory KYC, authorization documents if applicable and previous LUT information.'
                },
                {
                  step: 'Step 3',
                  title: 'Prepare FORM GST RFD-11',
                  desc: 'We prepare the LUT particulars and prescribed undertaking for the relevant financial year.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We assist with electronic filing of FORM GST RFD-11 on the GST portal through the authorized signatory workflow.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'After filing, we verify the acknowledgement and guide you on reporting zero-rated supplies correctly in GST returns.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Use the accepted LUT for eligible zero-rated supplies during the relevant financial year and maintain required export and GST records.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  LUT does not alter the legal status of the business. It is a GST undertaking linked to the existing GST-registered person for making eligible zero-rated supplies without payment of IGST.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-LUT compliance includes proper export invoicing, GST return reporting, export realization and adherence to applicable timelines and conditions.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  LUT can reduce upfront IGST cash-flow impact, but GST return filing, export documentation and prescribed timelines must still be followed.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The registered person remains responsible for satisfying LUT conditions and paying applicable tax and interest if prescribed export conditions are not met.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our GST advisors guide you on LUT eligibility, RFD-11 filing, zero-rated supply documentation and ongoing GST export compliance.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After LUT filing, exporters should continue to meet GST return, invoice, export and realization requirements to preserve the benefit of zero-rated supply without payment of IGST.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Keep GST registration particulars and authorized signatory details updated on the GST portal.'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Maintain appropriate banking and foreign-remittance records for export receipts where applicable.'
                },
                {
                  title: 'GST Return & Export Reporting',
                  desc: 'Report zero-rated supplies correctly in applicable GST returns and maintain reconciled export records.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Update GST registration details and authorized signatory information whenever relevant particulars change.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Track export timelines and receipt of export proceeds as applicable under GST and foreign-exchange rules.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                LUT vs IGST-Paid Export Route
              </h2>
            </div>

            <div className="overflow-x-auto bg-white rounded-2xl border border-slate-200 shadow-sm">
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead><tr className="bg-[#0B3D91] text-white"><th className="p-3.5">Parameter</th><th className="p-3.5 bg-orange-500 text-[#0B3D91]">Export under LUT</th><th className="p-3.5">Export with IGST Payment</th></tr></thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  {[
                    ['IGST at time of export','No upfront IGST on eligible zero-rated supply','IGST is paid upfront, subject to applicable refund route'],
                    ['Primary filing','FORM GST RFD-11 for the financial year','No LUT required for the tax-paid export route'],
                    ['Cash-flow impact','Lower upfront tax blockage','Higher upfront tax outflow until refund, where eligible'],
                    ['GST returns','Zero-rated supplies must still be reported correctly','Tax-paid exports must be reported correctly'],
                    ['Validity','LUT is generally valid for the relevant financial year','Not applicable'],
                    ['Compliance','Export timelines, realization and records remain important','Export, tax payment and refund documentation remain important']
                  ].map((row, idx) => <tr key={idx} className="hover:bg-slate-50">{row.map((cell, i) => <td key={i} className={`p-3.5 ${i===0?'font-bold text-slate-900':''} ${i===1?'bg-orange-50/60 font-semibold':''}`}>{cell}</td>)}</tr>)}
                </tbody>
              </table>
            </div>
          </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                GST Treatment for Exports under LUT
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Exports and eligible supplies to SEZ are zero-rated under GST. LUT permits eligible registered persons to make such supplies without payment of IGST, subject to prescribed conditions.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Zero-Rated Supply Treatment',
                  desc: 'Eligible exports and qualifying SEZ supplies can be treated as zero-rated supplies under GST, subject to statutory conditions.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'LUT allows the eligible supplier to avoid upfront IGST payment while continuing to comply with GST return and export requirements.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Input tax credit and refund eligibility, where applicable, remain subject to GST law, documentation and refund rules.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Maintain export invoices, shipping or service-export evidence, realization records and GST return reconciliations.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize LUT, GST return and export documentation for smoother ongoing compliance.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              LUT can support exporter cash flow by avoiding upfront IGST payment on eligible zero-rated supplies. Businesses may separately use banking, export finance and working-capital facilities as appropriate.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Exporters may use eligible bank finance, packing credit or working-capital facilities according to lender and regulatory conditions.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Businesses can explore export finance and banking facilities based on turnover, orders, receivables and lender eligibility.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'LUT is a tax-compliance facility and does not restrict the business from separately pursuing lawful equity or debt funding.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We review your GST profile and export model to identify the correct LUT filing approach for the financial year.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our GST specialists prepare the RFD-11 undertaking and supporting particulars to reduce common filing errors.'
                },
                {
                  title: 'GST Portal Filing & Follow-Up',
                ...
                },
                {
                  ...
                  desc: 'Get access to GST compliance guidance, LUT renewal reminders and export-document support.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Exporters Trust akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: '100% online workflows designed to reduce paperwork and simplify GST portal filing.',
                  icon: Clock
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your GST, KYC, export and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              File Your LUT with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional support for online LUT filing under GST. Transparent pricing, digital document handling and dedicated assistance for exporters across India.
            </p>
            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <p className="text-xs text-slate-200 leading-relaxed">
                  Download the akshayb2bsolutions mobile application for iOS &amp; Android. Access compliance documents, filing updates and direct support from your dashboard.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  <a
