...
interface MakeInIndiaRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — Make in India business setup assistance
const FAQ_ITEMS = [
  { q: 'What is Make In India Registration?', a: 'Make in India is a Government of India initiative, not a standalone statutory registration certificate. Businesses generally need the registrations, licences and approvals applicable to their legal structure, manufacturing activity, location and scale. Our service helps identify and coordinate those requirements.' },
  { q: 'Who can use Make In India setup assistance?', a: 'Indian entrepreneurs, manufacturers, startups, MSMEs and eligible domestic or foreign-invested businesses planning to establish or expand manufacturing or related operations in India can use this assistance.' },
  { q: 'What documents are generally required?', a: 'Requirements vary by business structure and activity. Common documents may include PAN and identity/address proof of promoters or directors, incorporation documents, registered-office proof, bank details, project or activity details, and documents required for GST, Udyam or sector-specific approvals.' },
  { q: 'How long does the setup process take?', a: 'There is no single universal timeline because Make in India is not one registration. Timelines depend on company incorporation, state approvals, sector licences, land or factory permissions and document readiness.' },
  { q: 'Do I need Udyam and GST registration?', a: 'Udyam registration may be useful for eligible MSMEs, while GST registration depends on the applicable law, turnover, supply pattern and business activity. We help assess which registrations apply to your project.' },
  { q: 'Does Make in India approval guarantee incentives?', a: 'No. Incentives are scheme-specific and depend on eligibility, sector, investment, location and state or central policies. We can help identify relevant registrations and application routes, but approval remains with the competent authority.' }
]

// Related services cross-linking items — Make in India adjacent services
const RELATED_SERVICES = [
  {
    title: 'Startup India Registration',
    desc: 'DPIIT recognition support for eligible startups, including document preparation and application guidance.',
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1565514020179-026b92b84bb6?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Private Limited Company Registration',
    desc: 'Company incorporation support for entrepreneurs establishing a scalable business entity in India.',
    img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'GST Registration',
    desc: 'GST registration guidance for eligible businesses based on turnover, activity and supply requirements.',
  ...
  {
    title: 'Factory License & Industrial Approvals',
    desc: 'Assistance with applicable factory, state and industrial approvals for manufacturing units.',
    img: 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your business name, logo and brand identity through trademark filing support.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'EPF & ESI Registration',
    desc: 'Employee statutory registration support for eligible establishments as your workforce grows.',
    img: 'https://images.unsplash.com/photo-1521791055366-0d553872125f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Business Compliance Consultation',
    desc: 'Requirement-based consultation for licences, registrations and post-setup compliance in India.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  }
]

export const MakeInIndiaRegistrationPage: React.FC<MakeInIndiaRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Manufacturing / Business');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Make In India Setup Assistance');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Make In India Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Build your manufacturing business in India with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Pricing depends on your business requirements and applicable approvals
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Make in India supports businesses that want to manufacture, invest, innovate or expand operations in India. It is not a separate certificate; the actual setup may involve company incorporation, Udyam/MSME, GST, IEC, labour registrations, factory or pollution approvals and other state or sector-specific permissions depending on the project.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Timeline Varies by Approval</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Handshake className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Manufacturing & Business Setup</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Incorporation & Registration Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Govt. Portal Filing Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Requirement-Based Quote</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our India business setup specialist has been assigned to your enquiry. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Proposed Business / Unit *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                State-level approvals, registrations and documentation can vary depending on the proposed manufacturing unit, business activity, investment and location.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                End-to-end guidance for business incorporation, Udyam/MSME, GST and applicable industrial or state approvals with coordinated document support.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">
                                  Business / Manufacturing Activity *
                                </label>
                                <select
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Promoter / Authorized Person Full Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Promoter / Authorized Person PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              ...
                              >
                                <option value="Make In India Setup Assistance">Make In India Setup Assistance — Price on Consultation</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get Expert Consultation</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Make In India Setup Assistance
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                A single assistance plan covering requirement assessment, document preparation and coordination for the registrations or approvals applicable to your business setup.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Make In India Assistance</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Requirement-based support for entrepreneurs and manufacturers setting up or expanding operations in India.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-3xl font-extrabold text-[#0D47A1]">Contact for Quote</span>
                    </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Business Setup Requirement Assessment',
                      'Company Incorporation / Entity Setup Guidance',
                      'Govt. Portal Filing Support Support',
                      'Industrial / State Approval Mapping',
                      'IEC / Trade & Sector Registration Guidance',
                      'Dedicated Business Setup Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Make In India Setup Assistance');
                ...
                >
                  Get Started with Make In India Assistance
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Make in India project begins with choosing the right legal entity and identifying the registrations and approvals needed for the proposed activity. Depending on the business, this may include company incorporation, Udyam/MSME, GST, IEC, labour registrations and state or sector-specific permissions.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for entrepreneurs, startups, MSMEs, manufacturers and businesses planning a new unit, capacity expansion, local production or investment in India.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Choosing the right entity and compliance path helps establish clear ownership, management, tax treatment and operating responsibilities from the beginning.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on the chosen structure, such as proprietorship, partnership, LLP or company, and on the laws applicable to the business activity.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  There is no separate mandatory Make in India certificate. The key requirement is to complete the registrations, licences and approvals that apply to the proposed business or manufacturing activity.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Eligible businesses may explore central and state incentives, industrial policies, startup benefits, MSME support and financing opportunities subject to scheme-specific eligibility.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Make in India setup assistance helps businesses map and complete the legal and compliance steps needed to establish or expand operations in India, with coordinated support for documentation, registrations and approvals.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Make In India Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              There is no single Make in India registration form. The setup process begins by understanding your proposed activity, business structure, investment and location, then identifying and completing the registrations and approvals that apply.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After the applicable registrations and approvals are completed, the business can proceed according to its legal structure and sector requirements. Depending on the setup, this may include incorporation certificates, GSTIN, Udyam acknowledgement, IEC or state/sector licences.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk helps identify applicable registrations, prepare supporting documents, assist with portal filings and coordinate follow-up for business and manufacturing setup requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Advantages of Setting Up Under Make in India
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'A properly registered business entity can enter contracts, open business banking facilities, hire employees and operate under a defined legal and tax framework.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Get coordinated documentation and filing support; the final timeline depends on the entity type, state, sector, required approvals and government processing.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible businesses may explore central or state industrial incentives, MSME benefits, startup programs and other schemes subject to the specific eligibility conditions.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Starting Your Make in India Setup
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Business Name & Entity Selection',
                ...
                {
                  title: 'Define Manufacturing / Business Activity',
                  desc: 'Define the promoters, ownership structure, proposed investment, business activity and operational responsibilities before filing registrations or approvals.'
                },
                {
                  title: 'Valid Identity and Address Proofs of All Members / Trustees',
                  desc: 'Ensure promoter or director PAN, Aadhaar and other KYC details are accurate and consistent with the documents used for incorporation and registration filings.'
                },
                {
                ...
                {
                  title: 'Prepare Entity & Project Documents',
                  desc: 'Clearly define the products or services, manufacturing process, proposed location, ownership structure and scale so the correct licences and registrations can be mapped.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Who Can Start a Make in India Business Setup?
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Eligibility depends on the legal entity and the proposed business activity. Individuals, partnerships, LLPs and companies may establish eligible businesses in India, subject to applicable incorporation, investment, sector and state requirements.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The number of promoters, partners or directors depends on the chosen legal entity and the law governing that structure.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Promoters, partners or directors must satisfy the identity, address, eligibility and KYC requirements applicable to the selected business structure.'
                },
                {
                  title: 'Business Name Availability',
                  desc: 'The proposed entity or brand name should comply with applicable naming rules and should be checked for obvious conflicts or trademark issues where relevant.'
                },
                {
                  title: 'Entity Formation Documents',
                  desc: 'Prepare the incorporation, partnership, LLP or other constitutive documents required for the selected legal structure.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The business should have a valid registered office or principal place of business with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated or controlled sectors may require additional licences, approvals, investment conditions or prescribed entity structures before operations can begin.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions reviews promoter KYC, entity documents and project details to identify obvious gaps before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Commonly Required for Business Setup
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Common business setup documents include identity and address proof of promoters or directors, PAN, registered-office proof, incorporation or entity documents, bank details and project/activity information. Additional documents depend on the registrations and licences required.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Scanned PAN copies of the proprietor, partners, promoters or directors, as applicable to the selected business structure.'
                },
                {
                  title: 'Members / Trustees\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Accepted identity and address proof such as Aadhaar, Voter ID, Passport or other applicable KYC documents for the proprietor, partners, promoters or directors.'
                },
                {
                ...
                {
                  title: 'Signed Incorporation / Entity Documents',
                  desc: 'Signed incorporation or entity documents required for the selected business structure, along with declarations and supporting attachments where applicable.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our documentation team helps prepare applicable incorporation papers, declarations, NOC drafts and supporting documents according to the identified registration or approval requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Make In India Business Setup Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Prepare Entity & Project Documents',
                  desc: 'We help prepare and organize the entity-formation documents and declarations required for the selected business structure.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Members / Trustees',
                  desc: 'Upload PAN, identity/address proof, registered-office proof, NOC where required and the KYC documents needed for the proprietor, partners, promoters or directors.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify Business / Company Name',
                  desc: 'Our team helps check the proposed business or company name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped Business Entity deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the Business Entity\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the applicable incorporation or registration acknowledgements and continue with banking, tax, labour and operational formalities required before or after commencement.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status of Your Business in India
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal status of the business depends on the chosen structure. A company or LLP has a separate legal identity, while proprietorship and partnership structures have different ownership and liability characteristics.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-setup compliance depends on the entity, workforce and activity and may include annual filings, tax returns, GST, labour law compliance, licence renewals, accounting and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Different entity structures offer different levels of ownership flexibility, continuity, liability protection and compliance. The best choice depends on the promoters, scale and funding plan.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The responsibilities and liability of proprietors, partners, designated partners, directors and shareholders depend on the selected legal structure and applicable law.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our advisors guide you on the appropriate business structure, registrations, tax setup, sector approvals and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After setup, businesses must follow the ongoing compliance requirements applicable to their entity, taxes, employees, licences and industry to remain in good standing.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the Business Entity\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a business bank account in the registered entity name with the required incorporation and KYC documents.'
                },
                {
                  title: 'Annual Business Compliance & Tax Filing',
                  desc: 'File the Business Entity\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the relevant registering authority',
                  desc: 'Report applicable changes to directors, partners, registered office, business particulars or statutory records to the relevant authority where required.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the Business Entity employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian Business Entity Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on Business Entity structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & Compliance Considerations in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Business tax treatment depends on the legal structure, activity, turnover and applicable tax rules. Income tax, GST, TDS and other obligations should be assessed for the specific business.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on Business Entity Structure',
                  desc: 'Tax liability and filing obligations depend on whether the business is a proprietorship, partnership, LLP, company or another permitted structure.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Businesses should use proper invoicing and accounting practices and comply with the tax conditions applicable to their operations.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Payments to partners, directors, promoters or employees are treated according to the tax rules applicable to the selected entity structure.'
                },
                {
                  title: 'GST Threshold Exemption Limits',
                  desc: 'GST registration depends on the applicable registration provisions, turnover, supply pattern and business circumstances; thresholds and compulsory-registration rules should be checked for the specific case.'
                },
                {
                  title: 'Mandatory Tax Audit Above Turnover Limits',
                  desc: 'Businesses should maintain proper books, supporting records and annual accounts and complete audits or filings required under applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the Business Entity structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Businesses may explore promoter capital, bank finance, MSME credit, investors and eligible central or state support programs depending on the entity, project and scheme criteria.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible businesses may explore institutional finance, central or state incentives and other support programs subject to the relevant eligibility conditions.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, businesses may explore working capital, term loans and other institutional finance for permitted activities.'
                },
                {
                  title: 'Pradhan Mantri MUDRA Yojana (PMMY)',
                  desc: 'Eligible micro and small businesses may explore suitable government-backed or bank financing programs subject to current scheme rules and lender approval.'
                },
                {
                  title: 'Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE)',
                  desc: 'Eligible MSMEs may explore credit-guarantee-backed lending and other collateral-light financing options subject to current scheme and lender conditions.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an Business Entity; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the suitable entity structure, registration path and approval checklist for your proposed activity.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound Business Entity deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Clear scope-based pricing with a custom quote after reviewing your business activity, location and required registrations or approvals.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting promoter KYC, financial records and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Start Your Make in India Business Journey
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Plan your manufacturing or business setup in India with structured guidance on entity formation, registrations, statutory approvals and compliance. Final requirements and fees depend on your activity and location.
            </p>
