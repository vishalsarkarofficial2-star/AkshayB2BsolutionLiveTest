...
// 6 Accordion FAQs (adapted from the Indian food-safety organisation Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is ISO 22000 Certification?', a: 'ISO 22000 is an internationally recognised Food Safety Management System (FSMS) standard designed for organisations in the food chain. It combines food-safety management, hazard control, prerequisite programmes, communication and continual improvement.' },
  { q: 'Who can apply for ISO 22000?', a: 'Food manufacturers, processors, packers, storage units, transporters, caterers, cloud kitchens, restaurants, ingredient suppliers, packaging businesses and other organisations involved in the food chain can implement ISO 22000.' },
  { q: 'What documents are generally required?', a: 'Typical requirements may include business registration details, FSSAI licence where applicable, site address, process flow, product details, food-safety policy/objectives, hazard-analysis records, SOPs, cleaning and hygiene records, supplier controls and other FSMS documents.' },
  { q: 'How long does ISO 22000 certification take?', a: 'The timeline depends on organisation size, product/process complexity, documentation readiness and audit scheduling. A practical turnaround may range from several working days to a few weeks.' },
  { q: 'Does ISO 22000 replace FSSAI registration or licence?', a: 'No. ISO 22000 is a management-system certification and does not replace statutory food-business licences or registrations such as FSSAI requirements in India.' },
  { q: 'Why is ISO 22000 useful for food businesses?', a: 'It can improve food-safety controls, customer trust, supplier management, audit readiness and credibility with institutional buyers, exporters, distributors and large B2B customers.' }
]

// Related services cross-linking items — sourced from food-safety organisation-adjacent structures
const RELATED_SERVICES = [
  { title: 'FSSAI Registration', desc: 'Basic FSSAI registration support for eligible small food businesses in India.', img: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=600&auto=format&fit=crop&q=80', price: '₹899' },
  { title: 'FSSAI State License', desc: 'State-level FSSAI licence support for eligible food businesses based on turnover and activity.', img: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'FSSAI Central License', desc: 'Central FSSAI licence support for eligible manufacturers, importers, exporters and larger food businesses.', img: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&auto=format&fit=crop&q=80', price: '₹3,999 Food Safety System Supports' },
  { title: 'ISO 9001 Certification', desc: 'Quality Management System certification support for consistent business processes and customer satisfaction.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: '₹1,999' },
  { title: 'HACCP Certification', desc: 'Hazard Analysis and Critical Control Point system support for food-safety risk control.', img: 'https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'ISO 14001 Certification', desc: 'Environmental Management System certification support for improved environmental performance.', img: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'GST Registration', desc: 'GST registration support for eligible food and hospitality businesses.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: '₹699' },
  { title: 'Trademark Registration', desc: 'Protect your food brand, restaurant name, product label or logo through trademark filing support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: '₹1,499 Food Safety System Supports' },
  { title: 'Import Export Code', desc: 'IEC registration support for eligible food exporters and importers.', img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]

export const Iso22000Page: React.FC<Iso22000PageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Food Business / Company');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('ISO 22000 Certification Package (₹2,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ISO 22000 Certification</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Food Safety Certification Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Fast FSMS Documentation Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Food Safety Management System support for Indian businesses
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  ISO 22000 Certification in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an food-safety organisation may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Audit Coordination Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Users2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Dedicated Food Safety Consultant</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>POPULAR FOOD SAFETY PACKAGE</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based food safety consultant has been assigned to your certification request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of ISO 22000 Certification *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your state, food-business activity and operating model help us understand the FSMS scope and documentation requirements.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why choose akshayb2bsolutions for ISO 22000?</span>
                              </div>
                              <p className="text-[11px]">
                                Get food-safety process review, hazard-control documentation, SOP guidance, audit-readiness support and certification coordination with minimal complexity.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Business PAN / FSSAI Number (Optional)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ISO 22000 Certification Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ISO 22000 Certification Package (₹2,999)">ISO 22000 Certification Package — ₹2,999 Food Safety System Supports</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start ISO 22000 Process</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'legal-status', label: 'Certification Scope' },
                { id: 'post-compliance', label: 'Post-Certification' },
                { id: 'comparison', label: 'ISO 22000 vs Others' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple, Transparent Food Safety Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                ISO 22000 Certification Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package for food businesses that want structured FSMS documentation, hazard-control readiness and certification support without unnecessary complexity.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      FOOD SAFETY MANAGEMENT PACKAGE
                    </span>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">ISO 22000 Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for food manufacturers, processors, restaurants, cloud kitchens, caterers, storage units and suppliers seeking stronger food-safety controls and customer trust.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'FSMS Gap Review & Documentation Guidance',
                      'Food Safety Policy & Objective Support',
                      'Audit Coordination Guidance Support',
                      'SOP, Hygiene & Traceability Process Support',
                      'Audit Readiness & Certification Coordination',
                      'Dedicated ISO 22000 / Food Safety Consultant'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ISO 22000 Certification Package (₹2,999)');
                ...
                >
                  Get Started with ISO 22000 Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              ISO 22000 is a Food Safety Management System standard that helps organisations identify food-safety hazards, define controls, maintain hygiene and prerequisite programmes, improve traceability and manage food-safety responsibilities across the organisation.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for food manufacturers, processors, restaurants, caterers, cloud kitchens, storage and logistics units, packaging suppliers, ingredient suppliers and other organisations within the food chain.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A practical FSMS defines how hazards are identified, controlled, monitored and reviewed so food-safety risks are managed consistently.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The certification scope should accurately cover relevant food products, processes, facilities and activities so the certificate aligns with actual operations.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  ISO 22000 does not replace statutory food licences such as FSSAI requirements in India; it complements legal compliance with a structured food-safety management framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A well-implemented FSMS can reduce food-safety risks, improve customer confidence, strengthen supplier controls and support larger B2B or institutional opportunities.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, food-safety organisation registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How ISO 22000 Certification Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              food-safety organisation registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the food-safety organisation registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our legal desk helps prepare the appropriate MOA, Trust Deed, Society Rules, declarations, and supporting documents and assists with filing and government follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Stronger Food Safety Controls', desc: 'Build structured hazard identification, control, monitoring and corrective-action practices.' },
                { title: 'Better Customer & Buyer Confidence', desc: 'Demonstrate a recognised approach to food-safety management for customers, distributors and institutional buyers.' },
                { title: 'Improved Traceability', desc: 'Strengthen batch, supplier and process records so issues can be traced and managed more effectively.' },
                { title: 'Support for Audits & Vendor Approval', desc: 'Structured FSMS documentation can help during buyer audits, supplier assessments and B2B onboarding.' },
                { title: 'Reduced Food-Safety Risk', desc: 'Formal hazard controls and prerequisite programmes help reduce contamination and process failures.' },
                { title: 'Continual Improvement', desc: 'The standard encourages review, corrective action and ongoing improvement in food-safety performance.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before ISO 22000 Certification
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Define FSMS Scope', desc: 'Identify food products, processes, locations and activities that will fall within certification scope.' },
                { title: 'Map Process Flow', desc: 'Document receipt, storage, preparation, processing, packing, dispatch and other relevant steps.' },
                { title: 'Identify Food-Safety Hazards', desc: 'Review biological, chemical and physical hazards relevant to each process stage.' },
                { title: 'Establish Prerequisite Programmes', desc: 'Maintain hygiene, sanitation, pest control, cleaning, personal hygiene and facility controls.' },
                { title: 'Prepare Food-Safety Policy & Objectives', desc: 'Create clear management commitments and measurable food-safety goals.' },
                { title: 'Maintain Traceability & Supplier Records', desc: 'Keep practical records for ingredients, suppliers, batches and product movement.' },
                { title: 'Conduct Internal Readiness Review', desc: 'Check that documents and controls are being used before the certification audit.' },
                { title: 'Prepare for Certification Audit', desc: 'Ensure responsible staff, records, hazard-control documents and site conditions are audit-ready.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for ISO 22000 Certification
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a food-safety organisation in India, there must be a minimum of two management / authorised persons and a maximum of twenty. All management / authorised persons must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Management / Authorised Persons',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen food-safety organisation structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected food-safety organisation structure.'
                },
                {
                  title: 'Unique food-safety organisation Name Requirement',
                  desc: 'The food-safety organisation must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written food-safety organisation Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the food-safety organisation objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The food-safety organisation must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a food-safety organisation.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each authorised person\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your food-safety organisation registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Business Registration Proof', desc: 'Company, LLP, partnership, proprietorship or other legal constitution proof.' },
                { title: 'FSSAI Licence / Registration, If Applicable', desc: 'Current FSSAI details for regulated food-business activities in India.' },
                { title: 'Site Address & Facility Details', desc: 'Address and basic operational details of the location covered under certification.' },
                { title: 'Product & Process Flow Information', desc: 'Details of food products, ingredients, process steps and handling activities.' },
                { title: 'Existing SOPs / Hygiene / Cleaning Records', desc: 'Any current operating procedures, sanitation records, pest-control records or food-safety checklists.' },
                { title: 'Supplier, Traceability & Quality Records', desc: 'Existing supplier approvals, batch records, complaint records, test reports or traceability records where available.' }
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step ISO 22000 Certification Process
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'We prepare the appropriate governing document detailing the food-safety organisation objectives, management team, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Management / Authorised Persons',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique food-safety organisation Name',
                  desc: 'Our team helps check the proposed food-safety organisation name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped food-safety organisation deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the food-safety organisation\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the food-safety organisation registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the food-safety organisation bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an food-safety organisation depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the food-safety organisation structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a authorised person\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate food-safety organisation structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Post-Certification Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, food-safety organisations must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the food-safety organisation\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered food-safety organisation name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual food-safety organisation Compliance & Tax Filing',
                  desc: 'File the food-safety organisation\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the food-safety organisation employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian food-safety organisation Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Management / Authorised Persons
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Management / Authorised Persons</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on food-safety organisation structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Management / Authorised Persons
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Important ISO 22000 Considerations
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              food-safety organisation tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on food-safety organisation Structure',
                  desc: 'Tax liability and exemptions depend on whether the food-safety organisation is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible food-safety organisations must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working management / authorised persons are taxable in the authorised person\'s hands but deductible for the food-safety organisation, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible food-safety organisations should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the food-safety organisation structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Where ISO 22000 Adds Business Value
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              food-safety organisations generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible food-safety organisations may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, food-safety organisations may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an food-safety organisation; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your management / authorised persons\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound food-safety organisation deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                ...
                {
                  title: 'Dedicated Post-Certification Growth Advisory',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your management / authorised persons\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Build Safer Food Processes. Win More Trust.
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Get ISO 22000 with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their food-safety organisation with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
