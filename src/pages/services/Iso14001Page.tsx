...
const FAQ_ITEMS = [
  { q: 'What is ISO 14001:2026?', a: 'ISO 14001:2026 is the current international standard for Environmental Management Systems (EMS). It helps organizations systematically manage environmental responsibilities, improve environmental performance, address risks and opportunities, and support compliance with applicable environmental obligations.' },
  { q: 'Who can use ISO 14001?', a: 'ISO 14001 can be used by organizations of any size and sector, including manufacturing, construction, logistics, healthcare, hospitality, utilities, services, public-sector bodies and other businesses seeking a structured environmental management system.' },
  { q: 'What is included in our ISO 14001 support package?', a: 'Our package includes requirement assessment, EMS documentation guidance, environmental aspect and impact review support, policy and objective guidance, internal-audit readiness support and certification-process coordination.' },
  { q: 'Is ISO 14001 certification mandatory in India?', a: 'ISO 14001 certification is generally voluntary, but customers, tenders, supply chains, regulators or internal ESG goals may make it commercially valuable or operationally important for many organizations.' },
  { q: 'How does ISO 14001 certification work?', a: 'A business implements an Environmental Management System, performs internal review and management review, and then undergoes an audit by an independent certification body. Certification scope and timelines depend on the organization and certification body.' },
  { q: 'Can an ISO 14001:2015 certified company transition to ISO 14001:2026?', a: 'Yes. ISO 14001:2026 replaces the 2015 edition. Existing certified organizations should coordinate transition arrangements with their certification body within the applicable transition timeframe.' }
]

// Related services cross-linking items — sourced from Organization-adjacent structures
const RELATED_SERVICES = [
  { title: 'ISO 9001 Certification', desc: 'Quality Management System certification support for stronger processes, consistency and customer confidence.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ISO 45001 Certification', desc: 'Occupational Health & Safety Management System support for safer workplaces and better risk control.', img: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ISO 50001 Certification', desc: 'Energy Management System support to improve energy performance and operational efficiency.', img: 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ISO 22000 Certification', desc: 'Food Safety Management System certification assistance for eligible food-sector organizations.', img: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ISO 27001 Certification', desc: 'Information Security Management System support for protecting business and customer information.', img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible Indian micro, small and medium enterprises.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'Pollution Control Consent', desc: 'Support for understanding and preparing documentation for applicable pollution-control approvals.', img: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'ESG & Sustainability Support', desc: 'Structured support for sustainability policies, environmental goals, performance tracking and reporting readiness.', img: 'https://images.unsplash.com/photo-1531058020387-3be344556be6?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'EPR Registration', desc: 'Extended Producer Responsibility registration and compliance support for eligible waste streams in India.', img: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=600&auto=format&fit=crop&q=80', price: 'View Service' }
]

export const Iso14001Page: React.FC<Iso14001PageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Business / Organization');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('ISO 14001 Certification Support (₹1,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ISO 14001 Certification</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India ISO Certification Support Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">EMS Documentation & Audit Readiness</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start Your ISO 14001 Journey at{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Certification-body / accreditation-related charges, if applicable, are separate.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  ISO 14001 Certification in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an Organization may be registered as a applicable organization structure under applicable Indian laws.
                </p>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Special ₹1,999 Package</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based Organization specialist has been assigned to your ISO support request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            Certification-body fee, if any, is separate
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of ISO 14001 Certification *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your location and industry help us understand the operational context, environmental obligations and certification scope.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why choose ISO 14001 support with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get structured EMS guidance, documentation support, aspect-impact review assistance, internal-audit readiness and certification-process coordination in one clear package.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                PAN / Business Reference (Optional)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ISO 14001 Certification Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ISO 14001 Certification Package (₹1,999)">ISO 14001 Certification Package — ₹1,999 ISO 14001 Supports</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start ISO 14001 Support</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'financing', label: 'Business Value & Sustainability Impact' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Transparent ISO Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your ISO 14001 Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                A practical, conversion-focused package to help your organization prepare for ISO 14001:2026 implementation and certification with structured documentation and audit-readiness support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">ISO 14001 EMS Support</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    For businesses that want a structured Environmental Management System, stronger environmental controls and professional certification-readiness support.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'ISO 14001 Gap & Requirement Review',
                      'Environmental Policy & Objective Guidance',
                      'Certification Audit Support Support',
                      'EMS Documentation Checklist',
                      'Internal Audit & Management Review Readiness',
                      'Dedicated ISO 14001 Advisor'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ISO 14001 Certification Support (₹1,999)');
                ...
                >
                  Get Started with ISO 14001 EMS Support
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              Organization registration gives a non-governmental organization a recognized legal identity to operate for lawful charitable or social-welfare objectives. The organization may be structured as a applicable organization structure, with its governing documents defining its purpose, members or trustees, management, and rules.
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, EMS documentation, or EMS procedures clearly define the Organization's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The legal identity and liability framework depends on whether the Organization is formed as a applicable organization structure; the governing documents and applicable law determine the responsibilities of members, trustees, directors, and office bearers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Registration under the Indian Organization Act is not mandatory, but it offers significant legal advantages, including the right to sue third parties and fellow management team in case of disputes.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An Organization is not formed for distributing profits to members. Eligible organizations can pursue donations, grants, CSR opportunities, and other lawful funding avenues subject to applicable approvals and compliance.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Organization registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How ISO 14001 Certification Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Organization registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a applicable organization structure.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the Organization ISO certification or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our legal desk helps prepare the appropriate MOA, EMS documentation, EMS procedures, declarations, and supporting documents and assists with filing and government follow-up.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'Create a systematic framework to monitor, control and continually improve your organization’s environmental performance.'
                },
                {
                  title: 'Reduce Waste & Resource Use',
                  desc: 'Identify opportunities to reduce waste, energy consumption, water use and unnecessary resource costs.'
                },
                {
                  title: 'Strengthen Compliance Processes',
                  desc: 'Build a structured approach for identifying and managing applicable environmental obligations and operational controls.'
                },
                {
                  title: 'Win Customer & Supply-Chain Trust',
                  desc: 'ISO 14001 can strengthen credibility with customers, procurement teams, global buyers and sustainability-conscious stakeholders.'
                },
                {
                  title: 'Manage Environmental Risks',
                  desc: 'Assess environmental aspects, risks and opportunities before they become operational, reputational or compliance problems.'
                },
                {
                  title: 'Support Sustainable Growth',
                  desc: 'Build environmental thinking into leadership, planning, operations, performance evaluation and continual improvement.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  ...
                  desc: 'Identify the sites, activities, products and services that will be covered by your Environmental Management System.'
                },
                {
                  title: 'Identify Environmental Aspects',
                  desc: 'List activities that interact with the environment, such as emissions, waste, energy, water, chemicals and resource use.'
                },
                {
                  title: 'Understand Compliance Obligations',
                  desc: 'Identify applicable environmental legal, regulatory, customer and contractual requirements.'
                },
                {
                  title: 'Create Environmental Policy',
                  desc: 'Establish leadership commitments covering environmental protection, compliance and continual improvement.'
                },
                {
                  title: 'Set Objectives & Targets',
                  desc: 'Define measurable environmental goals such as reducing waste, energy use, water consumption or emissions.'
                },
                {
                  title: 'Prepare EMS Documentation',
                  desc: 'Create required procedures, controls, records and operational evidence aligned with your organization.'
                },
                {
                  title: 'Conduct Internal Audit',
                  desc: 'Check whether the EMS is implemented effectively and identify gaps before external certification audit.'
                },
                {
                  title: 'Complete Management Review',
                  desc: 'Leadership reviews EMS performance, risks, objectives, audit findings and improvement opportunities before certification.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for ISO 14001 Certification
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a Organization in India, there must be a minimum of two management team and a maximum of twenty. All management team must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Manufacturing & Processing Units',
                  desc: 'Suitable for factories and production facilities seeking structured environmental controls and stronger supply-chain credibility.'
                },
                {
                  title: 'Construction & Infrastructure',
                  desc: 'Useful for organizations managing waste, materials, dust, emissions, resource use and environmental site risks.'
                },
                {
                  title: 'Logistics & Transport',
                  desc: 'Supports systematic management of fuel use, emissions, waste, operational risks and environmental objectives.'
                },
                {
                  title: 'Hospitality & Healthcare',
                  desc: 'Applicable to hotels, hospitals and service facilities managing waste, water, energy and operational environmental impacts.'
                },
                {
                  title: 'Energy & Utility Businesses',
                  desc: 'Supports organizations focused on environmental performance, resource efficiency and measurable improvement.'
                },
                {
                  title: 'MSMEs & Growing Businesses',
                  desc: 'ISO 14001 can be scaled for smaller organizations that want stronger processes and customer or tender credibility.'
                },
                {
                  title: 'Public & Service Organizations',
                  desc: 'The standard can be implemented by non-manufacturing organizations and public-sector bodies as well.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  ...
                  desc: 'Basic information about sites, activities, products, services and the intended certification scope.'
                },
                {
                  title: 'Environmental Policy',
                  desc: 'Leadership-approved environmental commitments aligned with ISO 14001 requirements.'
                },
                {
                  title: 'Aspect & Impact Register',
                  desc: 'A structured record of environmental aspects, impacts and significance evaluation.'
                },
                {
                  title: 'Legal / Compliance Register',
                  desc: 'A record of applicable environmental obligations and how compliance is evaluated.'
                },
                {
                  title: 'Objectives & Improvement Plans',
                  desc: 'Environmental objectives, targets, responsibilities, timelines and monitoring methods.'
                },
                {
                  title: 'Operational, Audit & Review Records',
                  desc: 'Evidence of controls, monitoring, internal audit, corrective action and management review.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step ISO 14001 Certification Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Initial Requirement & Gap Review',
                  desc: 'Understand your current processes, certification scope and key gaps against ISO 14001:2026 requirements.'
                },
                {
                  title: 'EMS Planning & Documentation',
                  desc: 'Develop environmental policy, aspect-impact framework, objectives, responsibilities and supporting EMS documents.'
                },
                {
                  title: 'Implementation & Operational Controls',
                  desc: 'Put documented controls into practice across relevant activities, departments and sites.'
                },
                {
                  title: 'Internal Audit & Corrective Actions',
                  desc: 'Review implementation, identify nonconformities or gaps and close them before certification audit.'
                },
                {
                  title: 'Management Review',
                  desc: 'Leadership evaluates EMS performance, objectives, risks, compliance status and improvement needs.'
                },
                {
                  title: 'Certification Body Audit',
                  desc: 'An independent certification body conducts the external audit and, after successful closure of findings, issues certification.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ISO 14001:2026 Management System Framework
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an Organization depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a authorized person\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate Organization structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                After Certification Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After ISO 14001 certification, the organization should maintain its EMS, monitor environmental performance, complete internal audits and management reviews, address nonconformities and remain ready for surveillance audits.
            </p>
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ISO 14001 Compared with Other ISO Standards
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Management Team
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Management Team</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Management Team
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Environmental Aspects & Performance Areas
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Monitor and improve use of energy, raw materials, fuel and other resources to reduce environmental impact and operating waste.'
                },
                {
                  title: 'Waste Management',
                  desc: 'Identify waste streams, improve segregation and disposal controls, and set measurable reduction or recovery objectives.'
                },
                {
                  title: 'Water Management',
                  desc: 'Track significant water use, leakage, discharge or conservation opportunities relevant to the organization.'
                },
                {
                  title: 'Air Emissions & Pollution',
                  desc: 'Identify relevant emissions, dust, fumes, noise or pollution risks and establish suitable operational controls.'
                },
                {
                  title: 'Chemical & Hazardous Material Control',
                  desc: 'Manage storage, handling, spill response and disposal risks for applicable chemicals or hazardous materials.'
                },
                {
                  title: 'Environmental Performance Monitoring',
                  desc: 'Use indicators, records and reviews to measure progress against objectives and identify continual-improvement opportunities.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              ISO 14001 can support stronger environmental governance, operational efficiency, supply-chain credibility and sustainability performance across the organization.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tender & Customer Credibility',
                  desc: 'ISO 14001 can strengthen qualification and confidence where customers or procurement systems value certified environmental management.'
                },
                {
                  title: 'Supply-Chain Readiness',
                  desc: 'Demonstrate a structured EMS to larger buyers, exporters and supply-chain partners with sustainability expectations.'
                },
                {
                  title: 'Cost & Resource Efficiency',
                  desc: 'Better control of waste, energy, water and materials can reveal practical opportunities to reduce operating costs.'
                },
                {
                  title: 'ESG & Sustainability Alignment',
                  desc: 'Support broader sustainability goals with measurable environmental objectives, responsibilities and performance data.'
                },
                {
                  title: 'Reputation & Stakeholder Trust',
                  desc: 'A credible environmental management system can strengthen confidence among customers, employees, investors and communities.'
                },
                {
                  title: 'Continual Improvement',
                  desc: 'Regular audits, reviews and corrective actions help the organization improve environmental performance over time.'
                },
                {
                  title: 'Integration with Other ISO Systems',
                  desc: 'ISO 14001 can be integrated with standards such as ISO 9001, ISO 45001 and ISO 50001 for a more unified management approach.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your management team\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound Organization deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                ...
                {
                  title: 'Dedicated After Certification Growth Advisory',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden costs, crystal-clear pricing starting at just ₹1,999/-, and transparent separate government fee breakdowns.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your management team\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Build a Stronger, Greener & More Credible Business
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start ISO 14001 Support at ₹1,999
              </button>
              <button
