...
const FAQ_ITEMS = [
  { q: 'What is ISO/IEC 27001?', a: 'ISO/IEC 27001 is the international standard for an Information Security Management System (ISMS). It helps organizations identify information-security risks, apply appropriate controls, protect sensitive information and continually improve security governance.' },
  { q: 'Who should get ISO 27001 certification?', a: 'ISO 27001 is relevant for IT companies, SaaS businesses, fintechs, healthcare providers, BPOs, consultancies, e-commerce businesses, data processors, cloud-service providers and other organizations that handle important customer, employee or business information.' },
  { q: 'What is included in the ₹1,999 support package?', a: 'The package includes requirement assessment, ISMS scope guidance, risk-assessment support, policy and control-documentation guidance, internal-audit readiness and certification-process coordination.' },
  { q: 'Is ISO 27001 mandatory in India?', a: 'ISO 27001 certification is generally voluntary, but many customers, enterprise buyers, tenders, global clients and supply chains may require or strongly prefer certified information-security practices.' },
  { q: 'How does ISO 27001 certification work?', a: 'An organization defines its ISMS scope, identifies risks, selects and implements controls, maintains required documentation, completes internal audit and management review, and then undergoes an external certification audit by an independent certification body.' },
  { q: 'Which version of ISO 27001 should we follow?', a: 'The current standard is ISO/IEC 27001:2022. Certification and implementation work should align with the 2022 edition and its applicable requirements and controls.' }
]

// Related services cross-linking items — sourced from Organization-adjacent structures
const RELATED_SERVICES = [
  { title: 'ISO 9001 Certification', desc: 'Quality Management System support for process consistency, customer confidence and continual improvement.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ISO 14001 Certification', desc: 'Environmental Management System certification support for stronger environmental performance and operational controls.', img: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'ISO 45001 Certification', desc: 'Occupational Health & Safety Management System support for safer workplaces and better risk management.', img: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&auto=format&fit=crop&q=80', price: 'View Service' },
  { title: 'SOC 2 Readiness Support', desc: 'Prepare policies, controls, evidence and security processes for customer assurance and audit readiness.', img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'Cyber Security Audit', desc: 'Structured security review support to identify control gaps, operational risks and improvement priorities.', img: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'Data Privacy Compliance', desc: 'Support for building practical privacy policies, data-handling processes and compliance readiness.', img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  { title: 'VAPT Support', desc: 'Vulnerability assessment and penetration-testing coordination for identifying technical security weaknesses.', img: 'https://images.unsplash.com/photo-1510511459019-5dda7724fd87?w=600&auto=format&fit=crop&q=80', price: 'Get Quote' },
  ...
  { title: 'Trademark Registration', desc: 'Protect your company name, logo and brand identity with trademark registration support in India.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'View Service' }
]

export const Iso27001Page: React.FC<Iso27001PageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('ISO 27001 Certification Support (₹1,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ISO 27001 Certification</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India ISO & Information Security Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">ISMS Documentation & Audit Readiness</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start Your ISO 27001 Journey at{' '}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Structured ISMS Setup</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>ISMS Policy Documentation</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of ISO 27001 Certification *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your location, industry and data-handling model help us understand your ISMS scope and security-risk context.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why choose ISO 27001 support with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get structured ISMS guidance, risk-assessment support, security-policy documentation, internal-audit readiness and certification-process coordination in one clear package.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ISO 27001 Certification Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ISO 27001 Certification Package (₹2,999)">ISO 27001 Certification Package — ₹2,999 ISO 27001 Supports</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start ISO 27001 Support</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'financing', label: 'Business Value & Customer Trust' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your ISO 27001 Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                A focused support package to help your organization prepare for ISO/IEC 27001:2022 implementation and certification with structured documentation and audit-readiness guidance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">ISO 27001 ISMS Support</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for businesses that want stronger information-security governance, customer trust and certification-readiness support.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'ISO 27001 Gap & Requirement Review',
                      'ISMS Scope & Risk Assessment Support',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ISO 27001 Certification Support (₹1,999)');
                ...
                >
                  Get Started with ISO 27001 ISMS Support
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Properly drafted MOA, ISMS documentation, or ISMS procedures clearly define the Organization's objectives, governance, membership or trusteeship, powers, duties, and operational framework.
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our legal desk helps prepare the appropriate MOA, ISMS documentation, ISMS procedures, declarations, and supporting documents and assists with filing and government follow-up.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Build Customer & Enterprise Trust',
                  desc: 'Demonstrate a structured approach to protecting sensitive business and customer information.'
                },
                {
                  title: 'Reduce Information Security Risk',
                  desc: 'Identify threats, vulnerabilities and control gaps before they lead to operational or reputational damage.'
                },
                {
                  title: 'Strengthen Security Governance',
                  desc: 'Create clear responsibilities, policies, review mechanisms and management oversight for information security.'
                },
                {
                  title: 'Support Tender & Vendor Requirements',
                  desc: 'ISO 27001 can strengthen qualification where enterprise customers and procurement teams require formal security assurance.'
                },
                {
                  title: 'Improve Incident Readiness',
                  desc: 'Establish defined processes for identifying, reporting, responding to and learning from information-security incidents.'
                },
                {
                  title: 'Support Scalable Growth',
                  desc: 'Build repeatable controls for people, technology, suppliers, access, assets and data as the organization grows.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Define the ISMS Scope',
                  desc: 'Identify the sites, systems, teams, services and information assets that will fall within the Information Security Management System.'
                },
                {
                  title: 'Identify Information Assets',
                  desc: 'List important data, applications, infrastructure, people, vendors and business information that require protection.'
                },
                {
                  title: 'Perform Risk Assessment',
                  desc: 'Identify threats, vulnerabilities, likelihood, impact and treatment priorities using a structured risk methodology.'
                },
                {
                  title: 'Select Relevant Controls',
                  desc: 'Choose appropriate security controls and document why they are applicable or not applicable in the Statement of Applicability.'
                },
                {
                  title: 'Create Security Policies',
                  desc: 'Prepare practical policies covering access, acceptable use, incidents, assets, suppliers, backup, continuity and other relevant areas.'
                },
                {
                  title: 'Implement & Record Controls',
                  desc: 'Put selected controls into operation and maintain evidence showing they are actually working.'
                },
                {
                  title: 'Conduct Internal Audit',
                  desc: 'Review the ISMS against ISO/IEC 27001 requirements and identify gaps before external certification audit.'
                },
                {
                  title: 'Complete Management Review',
                  desc: 'Leadership evaluates ISMS performance, risks, incidents, objectives, audit findings and improvement actions.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  ...
                  desc: 'Suitable for development companies, IT service providers and technology businesses handling sensitive client information.'
                },
                {
                  title: 'SaaS & Cloud Businesses',
                  desc: 'Highly relevant for SaaS platforms, cloud-service providers and digital products managing customer or enterprise data.'
                },
                {
                  title: 'Fintech & Financial Services',
                  desc: 'Supports organizations that need stronger security governance, risk management and customer assurance.'
                },
                {
                  title: 'Healthcare & Data-Driven Businesses',
                  desc: 'Useful for organizations handling personal, confidential, medical or other sensitive information.'
                },
                {
                  title: 'BPO, KPO & Consulting Firms',
                  desc: 'Helps service providers demonstrate controlled information handling and structured security management to clients.'
                },
                {
                  title: 'E-commerce & Digital Businesses',
                  desc: 'Supports organizations managing customer accounts, payment-related information, platforms and third-party services.'
                },
                {
                  title: 'MSMEs & Growing Companies',
                  desc: 'The ISMS can be scaled to smaller businesses that want stronger controls, better enterprise credibility and certification readiness.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  ...
                  desc: 'Defines the business units, locations, systems and services included in the Information Security Management System.'
                },
                {
                  title: 'Information Security Policy',
                  desc: 'Leadership-approved policy describing the organization’s commitment to information security.'
                },
                {
                  title: 'Risk Assessment & Treatment Records',
                  desc: 'Documents information-security risks, evaluation criteria, treatment decisions and selected mitigation actions.'
                },
                {
                  title: 'Statement of Applicability',
                  desc: 'Lists applicable ISO 27001 Annex A controls and records the justification for inclusion or exclusion.'
                },
                {
                  title: 'Security Procedures & Control Records',
                  desc: 'Evidence for access control, assets, suppliers, backup, incidents, continuity, change, monitoring and other applicable controls.'
                },
                {
                  title: 'Internal Audit & Management Review Records',
                  desc: 'Proof that the ISMS has been reviewed internally and by leadership before certification audit.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Initial Gap & Scope Review',
                  desc: 'Understand your organization, services, data flows, existing security controls and intended ISMS certification scope.'
                },
                {
                  title: 'Risk Assessment & Control Mapping',
                  desc: 'Identify information-security risks and map suitable ISO 27001 controls to your business context.'
                },
                {
                  title: 'Policy & ISMS Documentation',
                  desc: 'Develop core ISMS policies, procedures, responsibilities, records and the Statement of Applicability.'
                },
                {
                  title: 'Implementation & Evidence Collection',
                  desc: 'Put the controls into practice and maintain evidence showing how security processes operate.'
                },
                {
                  title: 'Internal Audit & Management Review',
                  desc: 'Check readiness, close gaps and complete leadership review before the certification audit.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ISO 27001 Compared with Other Security Standards
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Define who can access systems, data and facilities, and ensure access is approved, reviewed and removed when no longer needed.'
                },
                {
                  title: 'Asset & Data Management',
                  desc: 'Identify important information assets, assign ownership and apply appropriate handling and protection rules.'
                },
                {
                  title: 'Supplier & Third-Party Security',
                  desc: 'Assess security risks from vendors, cloud providers, processors and other external service partners.'
                },
                {
                  title: 'Incident Management',
                  desc: 'Create a clear process for reporting, assessing, responding to and learning from information-security incidents.'
                },
                {
                  title: 'Business Continuity & Backup',
                  desc: 'Protect critical information and services through backup, recovery and continuity planning.'
                },
                {
                  title: 'Security Monitoring & Improvement',
                  desc: 'Track incidents, audit findings, risk changes and performance indicators to continually improve the ISMS.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Enterprise Sales Credibility',
                  desc: 'ISO 27001 can reduce friction in customer security reviews and help strengthen trust with larger buyers.'
                },
                {
                  title: 'Tender & Vendor Qualification',
                  desc: 'Many procurement processes value recognized information-security certification when evaluating suppliers.'
                },
                {
                  title: 'Stronger Customer Confidence',
                  desc: 'A certified ISMS signals that information security is managed systematically rather than informally.'
                },
                {
                  title: 'Reduced Operational Risk',
                  desc: 'Structured risk assessment and control ownership help prevent avoidable security failures and confusion.'
                },
                {
                  title: 'Better Internal Accountability',
                  desc: 'Clear policies, roles, evidence and review processes make information-security responsibilities easier to manage.'
                },
                {
                  title: 'Scalable Security Foundation',
                  desc: 'Build a repeatable governance model that supports growth into new teams, systems, locations and markets.'
                },
                {
                  title: 'Integration with Other Standards',
                  desc: 'ISO 27001 can be integrated with management systems such as ISO 9001, ISO 14001 and ISO 45001 where appropriate.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Protect Data. Build Trust. Win Better Clients.
            </h2>
