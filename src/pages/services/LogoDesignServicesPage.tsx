...
interface LogoDesignServicesPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs — Brand Logo Design
const FAQ_ITEMS = [
  { q: 'What is included in Brand Logo Design?', a: 'Our Brand Logo Design service focuses on creating a professional visual identity aligned with your business, audience and positioning. The scope can include logo concepts, typography direction, colour palette guidance, refinements and final export files based on the selected package scope.' },
  { q: 'Do you use templates or create custom logos?', a: 'The service is positioned around custom brand-led design. We study your business, competitors, audience and preferred style before developing concepts that fit your brand direction rather than simply placing your name into a generic template.' },
  { q: 'How many logo concepts will I receive?', a: 'The exact number of concepts and revision rounds depends on the final scope agreed for your project. Before work starts, we explain what is included so expectations are clear.' },
  { q: 'What files can I receive after approval?', a: 'Final deliverables can include high-resolution PNG and JPG files, transparent-background versions and, where included in scope, scalable/vector or print-ready formats for practical brand use.' },
  { q: 'Can you design a logo for an existing business?', a: 'Yes. We can create a new visual identity for a new business or refresh an existing logo while keeping important brand recognition elements where appropriate.' },
  { q: 'Why is there no fixed price on this page?', a: 'Logo design requirements vary by research depth, concept count, revision rounds, source-file needs, brand-guideline requirements and turnaround expectations. We first understand your requirement and then provide a clear custom quote.' }
]

// Related branding, design and digital services
const RELATED_SERVICES = [
  {
    title: 'Brand Identity Design',
    desc: 'Build a cohesive visual identity with logo direction, colour palette, typography and practical brand-use guidance.',
    img: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Business Card Design',
    desc: 'Create professional business cards that match your new brand identity and make a strong first impression.',
    img: 'https://images.unsplash.com/photo-1586717799252-bd134ad00e26?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Social Media Creative Design',
    desc: 'Branded Instagram, Facebook and promotional creatives designed for consistency across your digital presence.',
    img: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Website Design & Development',
    desc: 'Turn your brand identity into a fast, responsive and conversion-focused website for your business.',
    img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&auto=format&fit=crop&q=80',
    price: 'View Service'
  },
  {
    title: 'Company Profile Design',
    desc: 'Present your business professionally with a branded company profile for clients, partners and sales outreach.',
    img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Brochure Design',
    desc: 'Create visually strong brochures and service catalogues that communicate your offer clearly and professionally.',
    img: 'https://images.unsplash.com/photo-1586075010923-2dd4570fb338?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Packaging Design',
    desc: 'Build packaging visuals that make your product look credible, memorable and retail-ready.',
    img: 'https://images.unsplash.com/photo-1589365278144-c9e705f843ba?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your approved brand name or logo with professional trademark registration support in India.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'View Service'
  },
  {
    title: 'Digital Marketing',
    desc: 'Promote your brand through performance-focused digital campaigns, content and social media marketing.',
    img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  }
]

export const LogoDesignServicesPage: React.FC<LogoDesignServicesPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Business / Brand');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Brand Logo Design Package');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Brand Logo Design</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Creative Design Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Custom Brand-Focused Design</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Make Your Brand Look Professional, Memorable & Trustworthy{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Pricing is tailored to your design scope, revisions and deliverables.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Brand Logo Design in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an Brand may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Brand Discovery First</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Typography & Colour Direction</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Zap className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Refinement Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                ...
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <h3 className="text-xl font-bold text-slate-900">Design Request Received!</h3>
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our design specialist has been assigned to review your brand requirement. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            Final quote after requirement review
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Brand Logo Design *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your location helps us understand your market, audience and business context while planning the design direction.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why design your logo with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Clear requirement gathering, custom design direction, meaningful concepts, revision support and practical final files—focused on helping your brand look credible and customer-ready.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Brand Name / Business Name (Optional)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                                ...
                                maxLength={60}
                                className="w-full bg-slate-50 border border-slate-300 rounded-lg px-3 py-2 text-xs font-semibold text-slate-900 focus:outline-none focus:border-[#0B3D91]"
                              />
                            </div>

                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Brand Logo Design Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Brand Logo Design Package (Custom Quote)">Brand Logo Design Package — Custom Quote Scope-Baseds</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get Design Consultation</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Design Approach' },
                { id: 'advantages', label: 'Benefits' },
                { id: 'checklist', label: 'Checklist' },
                { id: 'eligibility', label: 'Who It’s For' },
                { id: 'documents', label: 'What We Need' },
                { id: 'steps', label: 'Steps' },
                { id: 'legal-status', label: 'Design Principles' },
                { id: 'post-compliance', label: 'After Approval' },
                { id: 'comparison', label: 'Logo Options' },
                { id: 'tax-implications', label: 'Visual Elements' },
                { id: 'financing', label: 'Usage & Growth' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Brand Logo Design Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused logo-design package tailored around your business, audience and desired brand personality. Final scope and pricing are shared after we understand your exact requirement.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      CUSTOM DESIGN — NOT TEMPLATE-LED
                    </span>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Professional Brand Logo Design</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for startups, local businesses, professionals and growing brands that want a polished, memorable and usable logo.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-sm font-bold text-slate-500">Design Scope</span>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Brand Discovery & Creative Brief',
                      'Custom Logo Concept Development',
                      'Digital & Print Ready Support',
                      'Revision & Refinement Support',
                      'Digital & Print-Ready Final Files',
                      'Dedicated Brand Designer Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Brand Logo Design Package');
                ...
                >
                  Get Started with Professional Brand Logo Design
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A strong brand logo is more than a decorative symbol. It visually communicates who you are, how you want customers to feel about your business and how your brand should be recognised across websites, social media, packaging, print and advertising.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Built for Your Audience:</strong>
                  The design direction should reflect the people you want to attract—whether you serve consumers, businesses, premium clients, local customers or a niche market.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Versatile Across Platforms:</strong>
                  A practical logo should remain clear and recognisable across websites, social media profiles, WhatsApp creatives, invoices, signage and print materials.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Clear Brand Personality:</strong>
                  Colours, typography, shapes and visual style should work together to communicate whether your brand is modern, premium, trustworthy, friendly, bold or professional.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Simple Enough to Remember:</strong>
                  The strongest logos avoid unnecessary complexity and use a distinct visual idea that customers can recognise quickly.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Designed for Long-Term Growth:</strong>
                  Your logo should be useful today and flexible enough to grow with your business as you expand into new products, cities, campaigns or digital channels.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, our goal is to create a logo that looks professional, feels relevant to your market and gives your business a stronger visual identity.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Brand Logo Design Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              We begin by understanding your business, audience, competitors, preferred style and where the logo will be used. This gives the design a clear strategic direction instead of starting with random visual ideas.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              From that brief, we develop logo directions, refine the strongest concept through feedback and prepare final files that are practical for digital and print use.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#0B3D91] flex items-center gap-1.5">
                ...
                <span>How akshayb2bsolutions Makes the Design Process Easier:</span>
              </h4>
              <p className="text-xs text-slate-600 leading-relaxed">
                Our design process keeps communication simple: clear brief, focused concepts, practical feedback rounds and final delivery without confusing design jargon.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Build Strong First Impressions',
                  desc: 'A professional logo can make your business look more established, credible and serious from the first customer interaction.'
                },
                {
                  title: 'Improve Brand Recognition',
                  desc: 'Consistent shapes, colours and typography help customers remember and identify your business more easily.'
                },
                {
                  title: 'Create Visual Consistency',
                  desc: 'A strong logo gives websites, social profiles, proposals, packaging and marketing materials a common visual anchor.'
                },
                {
                  title: 'Stand Out from Competitors',
                  desc: 'A custom visual identity helps you avoid looking generic or interchangeable in a crowded market.'
                },
                {
                  title: 'Support Premium Positioning',
                  desc: 'The right design language can make your brand feel more polished, trustworthy and aligned with the value you want to communicate.'
                },
                {
                  title: 'Grow with Confidence',
                  desc: 'A flexible logo system gives you a stronger foundation as your business expands into new products, locations and campaigns.'
                }
              ].map((item, idx) => (
            ...
            <p className="text-xs text-slate-500 text-center pt-2">
              akshayb2bsolutions focuses on practical design decisions that help your brand look consistent, memorable and customer-ready.
            </p>
          </div>
        </section>
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What to Decide Before We Design Your Logo
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Confirm Your Brand Name',
                  desc: 'Share the exact spelling, spacing and preferred capitalisation of your business or brand name.'
                },
                {
                  title: 'Define Your Target Audience',
                  desc: 'Tell us who your ideal customers are so the design can match their expectations and preferences.'
                },
                {
                  title: 'Choose Your Brand Personality',
                  desc: 'Decide whether your brand should feel premium, friendly, bold, minimal, modern, traditional, playful or highly professional.'
                },
                {
                  title: 'Share Preferred Colours',
                  desc: 'Let us know any colours you want to use, avoid or keep from your current branding.'
                },
                {
                  title: 'Provide Competitor References',
                  desc: 'Share competitor or inspiration examples to help us understand what fits your market and what should be differentiated.'
                },
                {
                  title: 'List Main Logo Use Cases',
                  desc: 'Tell us where the logo will appear—website, social media, shop signage, packaging, invoices, uniforms or print materials.'
                },
                {
                  title: 'Mention Symbols or Ideas',
                  desc: 'If your business has an important story, product, location or symbol, share it so we can assess whether it belongs in the concept.'
                },
                {
                  title: 'Keep Feedback Specific',
                  desc: "Clear feedback such as 'more premium', 'simpler icon' or 'stronger typography' helps us refine the concept faster."
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Brand Logo Design
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Our Brand Logo Design service is suitable for almost any business that wants a stronger visual identity—from new startups and local businesses to professionals, agencies, online brands and growing companies.
            </p>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'New Startups',
                  desc: 'Launch with a professional identity instead of using an inconsistent temporary logo.'
                },
                {
                  title: 'Local Businesses',
                  desc: 'Build stronger trust across storefronts, WhatsApp, Google Business Profile, social media and print materials.'
                },
                {
                  title: 'Professionals & Consultants',
                  desc: 'Create a clean personal or business identity that looks credible in proposals, websites and client communication.'
                },
                {
                  title: 'E-commerce & D2C Brands',
                  desc: 'Develop a visual mark that works across product listings, packaging, ads and social media.'
                },
                {
                  title: 'Existing Businesses Rebranding',
                  desc: 'Refresh an outdated or inconsistent logo while preserving useful brand recognition.'
                },
                {
                  title: 'Service Businesses',
                  desc: 'Stand out in competitive markets such as real estate, education, healthcare, finance, marketing and technology.'
                },
                {
                  title: 'Growing Companies',
                  desc: 'Create a scalable visual foundation before expanding into new locations, teams or marketing channels.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Brand Logo Design
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              No legal documents are required to start a logo design discussion. What helps most is a clear brand brief, business context and any visual references that communicate the direction you want.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Exact brand name, optional tagline and any preferred spelling or capitalisation.'
                },
                {
                  title: 'Business Description',
                  desc: 'A short explanation of what you sell, who you serve and what makes your offer different.'
                },
                {
                  title: 'Target Customer',
                  desc: 'Your ideal customer profile, location, market segment and buying context.'
                },
                {
                  title: 'Style References',
                  desc: 'Logos or visual styles you like or dislike, with a short note explaining why.'
                },
                {
                  title: 'Preferred Colours / Fonts',
                  desc: 'Any existing visual preferences or restrictions we should respect.'
                },
                {
                  title: 'Usage Requirements',
                  desc: 'Where the logo needs to work—website, social media, print, signage, packaging, app icon or other formats.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Brand Logo Design Process
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Brand Discovery & Requirement Brief',
                  desc: 'We collect your business details, audience, positioning, style preferences, colour direction and logo-use requirements.'
                },
                {
                  title: 'Research & Visual Direction',
                  desc: 'We review your market, competitors and suitable design directions so the concept feels relevant but not generic.'
                },
                {
                  title: 'Concept Development',
                  desc: 'We explore logo ideas using typography, symbols, shapes and layout options that match your brand personality.'
                },
                {
                  title: 'Concept Presentation',
                  desc: 'We present the selected direction with context so you can understand how and why the design fits your brand.'
                },
                {
                  title: 'Revision & Refinement',
                  desc: 'We refine the chosen concept based on clear feedback, improving balance, typography, colour and usability.'
                },
                {
                  title: 'Final File Delivery',
                  desc: 'After approval, we prepare the agreed final logo files for practical use across digital and print applications.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Core Principles of Good Logo Design
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an Brand depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  A good logo should remain simple, distinctive, readable and adaptable. It should also work in small sizes, monochrome use and different brand environments.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a business owner\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate Brand structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After the final logo is approved, consistent use becomes important. Repeatedly changing colours, spacing or typography can weaken recognition.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Use the Approved Logo Consistently',
                  desc: 'Keep the same approved colours, proportions and typography across your main brand touchpoints.'
                },
                {
                  title: 'Create Social Media Variants',
                  desc: 'Prepare profile-image and cover-friendly logo versions so your brand looks consistent across platforms.'
                },
                {
                  title: 'Update Website & Digital Assets',
                  desc: 'Replace temporary or old branding on your website, email signatures, presentations and online listings.'
                },
                {
                  title: 'Prepare Print Materials',
                  desc: 'Use the correct high-resolution or vector format for business cards, brochures, signage and packaging.'
                },
                {
                  title: 'Protect Clear Space & Legibility',
                  desc: 'Avoid stretching, overcrowding or placing the logo on backgrounds that reduce visibility.'
                },
                {
                  title: 'Consider Trademark Protection',
                  desc: 'If the logo or brand name is commercially important, consider professional trademark advice for legal protection.'
                },
                {
                  title: 'Expand into Brand Guidelines',
                  desc: 'As your business grows, formalise colours, typography, logo rules and visual examples into a brand-guideline document.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Business Stakeholders
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Business Stakeholders</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on Brand structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Business Stakeholders
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Visual Elements in Logo Design
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Brand tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Typography',
                  desc: 'Font style shapes the personality of the brand—modern, premium, friendly, technical, traditional or bold.'
                },
                {
                  title: 'Colour Palette',
                  desc: 'Colour influences recognition and emotion, but choices should also remain practical across screens and print.'
                },
                {
                  title: 'Icon / Symbol',
                  desc: 'A strong symbol can improve memorability when it has a clear relationship to the brand idea.'
                },
                {
                  title: 'Shape & Geometry',
                  desc: 'Circles, lines, shields, monograms and abstract forms can communicate different visual qualities.'
                },
                {
                  title: 'Spacing & Balance',
                  desc: 'Good spacing makes a logo feel polished, readable and easier to use at different sizes.'
                },
                {
                  title: 'Scalability',
                  desc: 'The design should remain recognisable from a small mobile icon to large-format signage.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Once approved, your logo can become the visual foundation for your website, social profiles, stationery, packaging, presentations, signage and future brand campaigns.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Use the logo as a consistent visual anchor across your online presence and conversion pages.'
                },
                {
                  title: 'Social Media Branding',
                  desc: 'Apply the identity to profile images, highlights, banners, posts and promotional creatives.'
                },
                {
                  title: 'Business Stationery',
                  desc: 'Extend the visual identity to cards, letterheads, invoices and presentation templates.'
                },
                {
                  title: 'Packaging & Labels',
                  desc: 'Use the logo consistently on product packaging, stickers and shipping materials.'
                },
                {
                  title: 'Advertising Campaigns',
                  desc: 'Build stronger recognition by repeating the same visual identity across Meta Ads, Google Ads and offline promotions.'
                },
                {
                  title: 'Storefront & Signage',
                  desc: 'Prepare versions suitable for boards, displays, uniforms and physical-brand environments.'
                },
                {
                  title: 'Future Brand Guidelines',
                  desc: 'As the business scales, turn the logo into a complete brand system with documented visual rules.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-slate-200">
              ...
              {[
                {
                  ...
                  desc: 'We start with your business and audience instead of jumping straight into decoration.'
                },
                {
                  title: 'Custom Creative Direction',
                  desc: 'Concepts are shaped around your positioning, market and visual preferences.'
                },
                {
                  title: 'Clear Feedback Process',
                  desc: 'You get a simple process for reviewing concepts and communicating refinements.'
                },
                {
                  title: 'Practical Final Deliverables',
                  desc: 'Files are prepared for the real places your logo needs to work—digital, social and print.'
                },
                {
                  title: 'One-to-One Design Support',
                  desc: 'A dedicated design point of contact keeps the project organised from brief to final approval.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'No one-size-fits-all pricing. We first understand your concept count, revision needs, file formats and branding scope, then provide a clear custom quote.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your business stakeholders\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Build a Brand Identity Customers Remember
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Your logo is often the first visual signal customers see. Make it look professional, consistent and aligned with the quality of your business.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Request Your Logo Design Consultation
              </button>
              <button
