      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Income Tax Return Filing</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold bg-orange-500 text-[#0B3D91] border-r border-orange-600">Typical Income</th>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-slate-50">
                      {row.map((cell, cidx) => (
                        <td key={cidx} className={`p-3.5 ${cidx < 3 ? 'border-r border-slate-200' : ''} ${cidx === 0 ? 'font-bold text-slate-900' : ''} ${cidx === 1 ? 'bg-orange-50/60 font-semibold text-orange-800' : ''}`}>
                          {cell}
                        </td>
                      ))}
                    </tr>
