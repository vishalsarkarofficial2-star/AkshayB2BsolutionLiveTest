...
interface HepcRegistrationPageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian HEPC applicant Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is Handloom Export Promotion Council (HEPC)?', a: 'HEPC is an Export Promotion Council for the Indian handloom sector. Eligible exporters can seek membership and the applicable Registration-Cum-Membership Certificate (RCMC) support for handloom export activities.' },
  { q: 'Who can apply for HEPC registration?', a: 'Eligible merchant exporters and manufacturer exporters dealing in handloom products may apply, subject to the council\'s current membership criteria and document requirements.' },
  { q: 'Is IEC required for HEPC / RCMC application?', a: 'IEC is generally an important exporter document for RCMC-related applications. Other business, tax and product-related documents may also be required depending on the applicant profile.' },
  { q: 'What documents are commonly required?', a: 'Common documents may include IEC, PAN, GST registration, business constitution documents, bank details, export/product information and any declarations or proofs requested for the applicant category.' },
  { q: 'How much does HEPC registration cost?', a: 'We do not show a fixed professional fee on this page. Pricing depends on your exporter profile, document readiness and the scope of support required. Contact us for a custom quote.' },
  { q: 'Can you help with RCMC and export documentation?', a: 'Yes. Our support can include eligibility review, document checklist, application preparation, RCMC guidance and coordination for related export registrations such as IEC, AD Code and Certificate of Origin.' }
]
// Related services cross-linking items — sourced from HEPC applicant-adjacent structures
const RELATED_SERVICES = [
  { title: 'IEC Registration', desc: 'Get Import Export Code registration support for starting or regularising your export business in India.', img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'AD Code Registration', desc: 'Register your bank AD Code with customs ports for export shipment processing and shipping bill benefits.', img: 'https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'Certificate of Origin', desc: 'Assistance with export Certificate of Origin documentation for eligible international shipments.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'ICEGATE Registration', desc: 'Get support for ICEGATE registration and customs-related digital exporter onboarding.', img: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'GST Registration', desc: 'GST registration assistance for exporters and businesses engaged in taxable supply and export activities.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'Trademark Registration', desc: 'Protect your handloom brand name and logo before scaling into domestic and international markets.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'RCMC Registration Support', desc: 'Professional guidance for exporter council membership and Registration-Cum-Membership Certificate applications.', img: 'https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'Export Documentation Support', desc: 'Get help organising exporter KYC, shipping, banking and compliance documents before filing.', img: 'https://images.unsplash.com/photo-1516383607781-913a19294fd1?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible handloom manufacturers, traders and export-focused MSMEs.', img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop&q=80', price: 'Contact for Pricing' }
]
export const HepcRegistrationPage: React.FC<HepcRegistrationPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('HEPC applicant');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('HEPC Registration Support Package');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Handloom Export Promotion Council (HEPC)</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Handloom Export Promotion Council (HEPC) in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an HEPC applicant may be registered as a proprietorship, partnership, LLP, company or other eligible exporter constitution under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Application Support & Follow-up</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>IEC / GST / Firm Document Review</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>HEPC / RCMC Application Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Users2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Dedicated Export Consultant</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Exporter Support • Custom Quote</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our HEPC export registration specialist has been assigned to your enquiry. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Handloom Export Promotion Council (HEPC) *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Document requirements may vary depending on whether you are a manufacturer exporter, merchant exporter, partnership, LLP or company engaged in eligible handloom products.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get practical HEPC / RCMC application guidance, exporter document review, profile preparation and submission support with minimal back-and-forth.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Handloom Export Promotion Council (HEPC) Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="HEPC Registration Support Package">HEPC Registration Support Package — Contact for Pricing</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get HEPC Registration Support</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'legal-status', label: 'RCMC Status' },
                { id: 'post-compliance', label: 'Post-Registration' },
                { id: 'comparison', label: 'Exporter Categories' },
                { id: 'tax-implications', label: 'Export Compliance' },
                { id: 'financing', label: 'Export Growth' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your HEPC Support Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional HEPC registration guidance, document preparation, applicable government filing support, and dedicated compliance assistance.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">HEPC Exporter Support Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    A conversion-focused support package for handloom exporters who want expert guidance for HEPC membership / RCMC application, documentation and submission readiness.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-4xl font-extrabold text-[#0D47A1]">Contact for Pricing</span>
                    </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      ...
                      'HEPC / RCMC Application Guidance Support',
                      'Basic HEPC applicant Name Availability Check',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('HEPC Registration Support Package');
                ...
                >
                  Get Started with HEPC Exporter Support Package
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                What is Handloom Export Promotion Council (HEPC)?
              </h2>
            </div>

            {/* Definition paragraph */}
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              HEPC supports the promotion of Indian handloom exports and serves exporters operating in the handloom value chain. For eligible exporters, council membership and RCMC-related registration can strengthen access to export-promotion information, industry initiatives and a more organised exporter profile.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for handloom manufacturers, merchant exporters, artisan-led businesses, textile exporters and export-focused enterprises dealing in eligible handloom products.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A properly prepared exporter profile, product details and business documents can reduce avoidable queries and help your application move more smoothly.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Your eligibility and documentation can vary by constitution and exporter category, such as proprietorship, partnership, LLP, company, merchant exporter or manufacturer exporter.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  HEPC membership / RCMC can be valuable for eligible exporters seeking a recognised export-promotion council connection and streamlined export-compliance documentation.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  For growing handloom exporters, proper council registration can complement IEC, GST, customs and banking registrations required across the export journey.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, HEPC registration support helps eligible handloom exporters prepare a stronger, cleaner application. Our team assists with eligibility checks, document readiness, application preparation and related export-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Handloom Export Promotion Council (HEPC) Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              HEPC registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a proprietorship, partnership, LLP, company or other eligible exporter constitution.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the HEPC registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Benefits of HEPC Registration
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Legal recognition helps the HEPC applicant operate through a defined legal structure, enter agreements, maintain records, and pursue its stated charitable or social objectives.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Get professional documentation and registration support with transparent professional fees; the final timeline depends on HEPC applicant structure, state, authority, and government verification.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible HEPC applicants may access government schemes, grants, CSR opportunities, and donor programs subject to the relevant eligibility and compliance requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for HEPC Registration
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Unique HEPC applicant Name Selection',
                ...
                {
                  title: 'Clearly Defined HEPC applicant Objectives and Governance',
                ...
                },
                {
                  ...
                  desc: 'Clearly state the HEPC applicant objectives, governance, membership or trusteeship, powers, duties, meetings, accounts, and dissolution provisions in the governing document.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Handloom Export Promotion Council (HEPC)
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a HEPC applicant in India, there must be a minimum of two exporter / authorised signatory and a maximum of twenty. All exporter / authorised signatory must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Members / Trustees',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen HEPC applicant structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected HEPC applicant structure.'
                },
                {
                  title: 'Unique HEPC applicant Name Requirement',
                  desc: 'The HEPC applicant must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written HEPC applicant Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the HEPC applicant objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The HEPC applicant must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a HEPC applicant.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Handloom Export Promotion Council (HEPC)
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To process your HEPC registration smoothly, identity and address proofs of owners, partners, directors or authorised signatories, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'Accepted identity and address proof such as Aadhaar, Voter ID, Passport, or other applicable documents for owners, partners, directors or authorised signatories.'
                },
                {
                ...
                {
                  title: 'Signed MOA / Trust Deed / Society Rules',
                  desc: 'The applicable governing document signed/executed by the required owners, partners, directors or authorised signatories, covering HEPC applicant objectives and governance rules.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our legal drafting team prepares the applicable MOA, Trust Deed, Society Rules, NOC drafts, declarations, and supporting documents according to the relevant authority requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Handloom Export Promotion Council (HEPC) Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Draft MOA / Trust Deed / Society Rules',
                  desc: 'We prepare the appropriate governing document detailing the HEPC applicant objectives, founders/trustees, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Members / Trustees',
                  desc: 'Upload PAN, identity/address proof, registered-office proof, NOC where required, and photographs of the required owners, partners, directors or authorised signatories.'
                },
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique HEPC applicant Name',
                  desc: 'Our team helps check the proposed HEPC applicant name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped HEPC applicant deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the HEPC applicant\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the HEPC registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the HEPC applicant bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status of a HEPC applicant
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an HEPC applicant depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the HEPC applicant structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our export compliance advisors guide you on HEPC / RCMC application readiness, exporter constitution documents, IEC linkage, GST details and related export registrations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After obtaining or renewing RCMC, exporters should keep IEC and business details updated, maintain membership as applicable and complete amendments or renewals through the prescribed process.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the HEPC applicant\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered HEPC applicant name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual HEPC applicant Compliance & Tax Filing',
                  desc: 'File the HEPC applicant\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the HEPC applicant employs staff.'
                },
                {
                  title: 'akshayb2bsolutions HEPC Renewal & Compliance Support',
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                HEPC applicant vs Other Business Structures
              </h2>
            </div>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian HEPC applicant Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on HEPC applicant structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax Treatment for HEPC applicants in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              HEPC applicant tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on HEPC applicant Structure',
                  desc: 'Tax liability and exemptions depend on whether the HEPC applicant is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible HEPC applicants must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working exporter / authorised signatory are taxable in the authorised signatory\'s hands but deductible for the HEPC applicant, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible HEPC applicants should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the HEPC applicant structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              HEPC applicants generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible HEPC applicants may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, HEPC applicants may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an HEPC applicant; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your exporter / authorised signatory\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound HEPC applicant deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'No fixed professional fee is shown. Get a transparent custom quote based on exporter category, document readiness and support scope.',
                  icon: Tag
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your exporter / authorised signatory\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your HEPC applicant with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their HEPC applicant with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
