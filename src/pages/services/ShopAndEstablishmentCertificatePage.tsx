...
interface ShopAndEstablishmentCertificatePageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Indian business Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is a Shop and Establishment Certificate?', a: 'A Shop and Establishment Certificate is a state-level business registration issued under the applicable Shops and Establishments law. It helps establish the commercial presence of shops, offices, restaurants, service businesses and other covered establishments.' },
  { q: 'Who generally needs Shop and Establishment registration?', a: 'Shops, commercial establishments, offices, restaurants, service providers, professional establishments and other businesses covered by the applicable state law may need registration. The exact requirement depends on the state or Union Territory.' },
  { q: 'What documents are generally required?', a: 'Commonly required documents include identity proof of the proprietor, partner or authorised person, PAN, business address proof, rent agreement or ownership proof, passport-size photograph and business constitution documents, subject to state rules.' },
  { q: 'How long does Shop and Establishment registration take?', a: 'Processing time varies by state, local authority, document readiness and verification requirements. Some states provide online registration while others may require additional local verification.' },
  { q: 'Is Shop and Establishment registration the same across India?', a: 'No. Shops and Establishments laws are administered at the state or Union Territory level, so forms, fees, timelines, renewal rules and compliance requirements can differ.' },
  { q: 'Can this certificate be used as business proof?', a: 'The certificate is commonly used as an important local business registration and may support bank account opening, vendor onboarding, other licence applications and proof of commercial establishment, subject to the receiving organisation\'s requirements.' }
]

// Related services cross-linking items — sourced from business-adjacent structures
const RELATED_SERVICES = [
  {
    title: 'GST Registration',
    desc: 'GST registration assistance for eligible businesses across India.',
  ...
  {
    title: 'Trade License',
    desc: 'Local trade licence application assistance for eligible commercial establishments.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'FSSAI Registration',
    desc: 'Food business registration support for eligible small food businesses.',
  ...
  },
  {
    ...
    desc: 'Trademark application support to help protect your business name, logo and brand identity.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'IEC Registration',
    desc: 'Import Export Code application support for businesses engaged in import or export activities.',
    img: 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Business PAN / TAN Support',
    desc: 'PAN and TAN application guidance for eligible business entities and tax requirements.',
  ...
  },
  {
    ...
    desc: 'Ongoing assistance for registrations, renewals, amendments and other business compliance needs.',
    img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  }
]

export const ShopAndEstablishmentCertificatePage: React.FC<ShopAndEstablishmentCertificatePageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('Shop and Establishment Certificate (₹999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Shop and Establishment Certificate</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Business Registration Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">State-Specific Registration Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Get your Shop and Establishment Certificate at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Shop and Establishment registration is a state-level business registration for shops, offices, commercial establishments, restaurants, service providers and other covered businesses. Requirements, documents, fees and validity depend on the applicable state or Union Territory law.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Local Authority Filing Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Users2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Dedicated Registration Advisor</span>
                  </div>
                </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our business registration specialist has been assigned to your Shop and Establishment Certificate request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <h3 className="text-base font-extrabold text-[#0B3D91]">
                              Online Business Registration Desk
                            </h3>
                          </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State / UT of Establishment *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The applicable authority, form, government fee and documents depend on the state or Union Territory where the establishment is located.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                We help with eligibility review, document checklist, application preparation, government filing support and follow-up for the applicable state registration.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Proprietor / Authorized Person PAN (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Shop & Establishment Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Shop and Establishment Certificate (₹999)">Shop and Establishment Certificate — ₹999 + Govt. Fees</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Get Certificate Assistance</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Shop and Establishment Certificate Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes application guidance, document review, filing support and assistance for the applicable Shop and Establishment registration process.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Certificate Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Essential local business registration support for eligible shops, offices and commercial establishments.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Application Form Preparation & Review',
                      'Identity & Business KYC Checklist',
                      'State / Local Authority Filing Support',
                      'Business Establishment Details Review',
                      'Certificate Download / Issue Follow-Up',
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Shop and Establishment Certificate (₹999)');
                ...
                >
                  Get Started with Certificate Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Shop and Establishment Certificate is issued under the applicable state or Union Territory Shops and Establishments framework. It records key details of the commercial establishment and supports legal recognition of the workplace for applicable local compliance purposes.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for shops, offices, restaurants, service businesses, professional establishments, small businesses, startups and other covered commercial establishments.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The certificate records establishment details such as business name, address, nature of activity, employer or authorised person and other state-required particulars.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The registration requirement is linked to the establishment and applicable state law rather than to one specific business constitution.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  In many states, registration is required for covered establishments and should be completed within the prescribed period from commencement of business.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The certificate can support other business processes such as bank account opening, vendor onboarding and additional local registrations, subject to the receiving authority.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Shop and Establishment registration is an important local compliance requirement for many businesses. Our team assists with document preparation, filing and certificate follow-up.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Shop and Establishment Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              The business submits the prescribed application to the relevant state or local authority, generally with identity proof, business address proof, constitution documents and other state-specific information.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After verification and payment of the applicable government fee, the competent authority issues the Shop and Establishment Certificate or registration acknowledgement as per the state process.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk helps prepare the application, organize supporting documents, submit the filing and follow up with the applicable authority.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Recognised Local Business Registration',
                  desc: 'Provides an official local record of the establishment under the applicable state Shops and Establishments framework.'
                },
                {
                  title: 'Useful Business Proof',
                  desc: 'Can support bank account opening, vendor onboarding and other business processes where local establishment proof is requested.'
                },
                {
                  title: 'Simple Registration Process',
                  desc: 'Many states provide an online or simplified filing process, subject to document readiness and local verification.'
                },
                {
                  title: 'Improved Business Credibility',
                  desc: 'An official establishment certificate can improve credibility with banks, vendors, customers and service providers.'
                },
                {
                  title: 'Helps Maintain Labour Compliance',
                  desc: 'Registration forms part of the broader state-level framework governing conditions of employment and establishment records.'
                },
                {
                  title: 'Supports Other Registrations',
                  desc: 'The certificate may be used as supporting business proof for other registrations, licences and account-opening processes.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for Shop and Establishment Certificate
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Confirm Business Name & Constitution',
                  desc: 'Keep the correct business or establishment name and constitution details ready.'
                },
                {
                  title: 'Confirm Nature of Business Activity',
                  desc: 'Clearly identify the main activity carried out from the shop, office or establishment.'
                },
                {
                  title: 'Identify Employer / Authorized Person',
                  desc: 'Agree in advance on each owner / authorised person\'s capital contribution and profit/loss sharing ratio to avoid disputes after registration.'
                },
                {
                  title: 'Identity & PAN Documents',
                  desc: 'Ensure each owner / authorised person\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                  title: 'Establishment Address Proof',
                  desc: 'Prepare rent agreement, ownership proof, utility bill or other accepted proof of the establishment address.'
                },
                {
                  title: 'Business Constitution Documents',
                  desc: 'Keep applicable proprietorship, partnership, LLP, company or other constitution documents ready.'
                },
                {
                  title: 'Check State-Specific Requirements',
                  desc: 'Verify whether your state requires employee details, photographs, signage details, declaration forms or other local documents.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Shop and Establishment Certificate
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Shops, offices, restaurants, service establishments and other commercial establishments covered by the applicable state or Union Territory law may need registration. The exact coverage and exemptions depend on local rules.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Shops & Retail Establishments',
                  desc: 'Retail shops and similar commercial premises are commonly covered under state Shops and Establishments laws.'
                },
                {
                  title: 'Offices & Service Businesses',
                  desc: 'Commercial offices, agencies, consultancies and service providers may also be covered.'
                },
                {
                  title: 'Restaurants & Commercial Units',
                  desc: 'Restaurants and other commercial establishments may need registration depending on the applicable state law.'
                },
                {
                  title: 'Different Business Constitutions',
                  desc: 'Proprietorships, partnerships, LLPs, companies and other recognised structures may register the establishment where applicable.'
                },
                {
                  title: 'Valid Establishment Address',
                  desc: 'A valid address for the shop, office or commercial establishment is generally required.'
                },
                {
                  title: 'State-Specific Exemptions',
                  desc: 'Certain categories may be exempt or governed separately under state law, so local applicability should be checked.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each owner / authorised person\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Documents Required for Shop and Establishment Certificate
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Common documents include identity proof, PAN, establishment address proof, rent agreement or ownership proof, photograph and applicable business constitution documents. Exact requirements differ by state or Union Territory.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Owners / Authorized Persons\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each owner / authorised person\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Owners / Authorized Persons\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Aadhaar, Voter ID, Passport or other accepted KYC proof as required by the state authority.'
                },
                {
                  title: 'Establishment Address Proof',
                  desc: 'Recent utility bill, property document or other accepted proof of the commercial establishment address.'
                },
                {
                  title: 'Rent Agreement / Ownership Proof',
                  desc: 'Rent agreement, lease deed, ownership document or NOC may be required depending on the premises and state rules.'
                },
                {
                  title: 'Business Constitution Proof',
                  desc: 'Partnership deed, LLP or company document, proprietorship proof or other constitution document, where applicable.'
                },
                {
                  title: 'akshayb2bsolutions Document Review Support',
                  desc: 'Our team reviews the available documents and helps prepare the state-specific filing checklist and application set.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Shop and Establishment Registration Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Business Constitution Documents',
                  desc: 'We identify the applicable state or Union Territory registration requirement for your establishment.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Business & KYC Documents',
                  desc: 'Share PAN, identity proof, address proof, premises documents and constitution documents as applicable.'
                },
                {
                  step: 'Step 3',
                  title: 'Prepare Application Details',
                  desc: 'We prepare the business name, address, activity, employer and other required establishment details.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit to Applicable Authority',
                  desc: 'We file Form 1, the stamped application documents, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'Pay Applicable Government Fee',
                  desc: 'We apply for the business\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Issue & Download Support',
                  desc: 'After approval, we assist with certificate download, acknowledgement or issue follow-up as per the state process.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal & Compliance Position of Shop and Establishment Registration
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an business depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the business structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a owner / authorised person\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate business structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Post-Registration Compliance Checklist for Establishments
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, businesss must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the business\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered business name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual business Compliance & Tax Filing',
                  desc: 'File the business\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the business employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Shop and Establishment Registration vs Other Business Registrations
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Owners / Authorized Persons
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Owners / Authorized Persons</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on business structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Owners / Authorized Persons
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & Compliance Considerations for Registered Establishments
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              business tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on business Structure',
                  desc: 'Tax liability and exemptions depend on whether the business is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible businesss must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working owners / authorised persons are taxable in the owner / authorised person\'s hands but deductible for the business, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible businesss should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the business structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Business Use Cases for Shop and Establishment Certificate
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              businesss generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible businesss may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, businesss may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an business; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your owners / authorised persons\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound application documents, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your owners / authorised persons\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Get Your Shop and Establishment Certificate with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional assistance for your Shop and Establishment Certificate with document review, filing support and state-specific guidance.
            </p>
