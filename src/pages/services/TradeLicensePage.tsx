...
interface TradeLicensePageProps {
  onBackToHome: () => void;
...
// 6 Accordion FAQs (adapted from the Municipal / Local Body Rules framework)
const FAQ_ITEMS = [
  { q: 'What is a Trade License in India?', a: 'A Trade License is a permission issued by the local municipal authority or other competent local body allowing a business to carry on a specified trade or commercial activity at a particular premises, subject to applicable state and local rules.' },
  { q: 'Who needs a Trade License?', a: 'Businesses such as shops, offices, restaurants, warehouses, workshops, service establishments, manufacturers, and other commercial units may require a Trade License depending on the city, state, premises, and nature of activity.' },
  { q: 'What documents are generally required for a Trade License?', a: 'Common documents include identity and address proof of the applicant, business constitution proof, PAN, premises ownership or rent documents, recent utility bill, NOC where applicable, photographs, and activity-specific documents required by the local authority.' },
  { q: 'How long does Trade License registration take?', a: 'Processing time varies by municipality, state, business activity, document readiness, inspection requirements, and local authority workload. Applications are processed after document verification and any required inspection.' },
  { q: 'Is a Trade License the same as GST Registration?', a: 'No. A Trade License is a local permission to carry on a specified business activity, while GST Registration is a tax registration. Depending on the business, both may be required separately.' },
  { q: 'Does a Trade License need renewal?', a: 'Trade Licenses are generally issued for a specified validity period and may require renewal according to the rules of the issuing municipal or local authority. Renewal timelines and fees vary by jurisdiction.' }
]
...
const RELATED_SERVICES = [
  {
    ...
    desc: 'Get GST registration support for eligible businesses with application and compliance guidance.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'MSME Udyam Registration',
    desc: 'Register your eligible micro, small, or medium enterprise on the Udyam portal.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'FSSAI Registration',
    desc: 'Food business registration and licensing support for eligible food business operators.',
  ...
  },
  {
    ...
    desc: 'Registration support for shops, offices, and commercial establishments under applicable state rules.',
    img: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Professional Tax Registration',
    desc: 'Professional tax registration and enrollment support where applicable under state law.',
    img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your business name, logo, and brand identity with trademark filing support.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Import Export Code (IEC)',
    desc: 'IEC application support for businesses planning to import or export goods and services.',
    img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  },
  {
    title: 'Fire NOC Assistance',
    desc: 'Documentation and application guidance for fire safety NOC where required by local rules.',
  ...
  },
  {
    ...
    desc: 'Consent and compliance guidance for businesses requiring pollution control approvals.',
    img: 'https://images.unsplash.com/photo-1531058020387-3be344556be6?w=600&auto=format&fit=crop&q=80',
    price: 'Contact for Price'
  }
]

export const TradeLicensePage: React.FC<TradeLicensePageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('Trade License Package (₹999 + Govt. Fees)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Trade License</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Trade License Assistance</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Municipal Filing Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Get your Trade License at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  A Trade License is a local business permission issued by the relevant municipal corporation, municipality, panchayat, or other competent authority for carrying on a specified commercial activity from an approved premises. The exact process, validity, documents, and government fees vary by state, city, local body, and nature of business.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Local Authority Processing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Application & Document Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Municipal Authority Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>Professional Fee ₹999</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Trade License specialist has been assigned to your application. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The issuing authority, documents, government fees, and process depend on your state, city, local body, business activity, and premises.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Complete document review, application preparation, local authority filing guidance, and follow-up support with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Applicant / Business Owner Full Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              ...
                              >
                                <option value="Trade License Package (₹999 + Govt. Fees)">Trade License Package — ₹999 + Govt. Fees</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start Trade License Application</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Choose Your Trade License Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                This package includes professional Trade License application guidance, document review, local authority filing support, and dedicated compliance assistance.
              </p>
            </div>
              ...
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mb-6">
                    Professional assistance for obtaining a Trade License from the applicable local authority for your business premises and activity.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Trade License Application Preparation',
                      'Business & Applicant Document Review',
                      'Municipal / Local Authority Filing Support',
                      'Business Activity & Jurisdiction Check',
                      'Premises Document & NOC Guidance',
                      'Dedicated Trade License Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Trade License Package (₹999 + Govt. Fees)');
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Trade License authorizes a business to carry on a specified trade or commercial activity at a particular premises within the jurisdiction of the issuing local authority. It does not create a business entity; it is an operational permission that may be required in addition to registrations such as GST, Udyam, FSSAI, or Shop & Establishment.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Suitable for shops, offices, restaurants, warehouses, workshops, service providers, traders, and other commercial establishments where the local authority requires a Trade License.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The application identifies the business activity, premises, applicant details, and local jurisdiction so the correct municipal permission can be processed.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A Trade License does not change your business constitution or liability. Proprietorship, partnership, LLP, or company status remains governed by the respective business laws.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Trade License applicability depends on the business activity and local municipal rules. Where required, operating without a valid license may attract penalties, closure directions, or other local enforcement action.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A Trade License is linked to the approved premises and activity. Changes in address, ownership, activity, or other particulars may require amendment, fresh approval, or intimation to the local authority.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, a Trade License helps a business meet local municipal requirements for carrying on its approved activity. Our team supports document review, application preparation, filing guidance, authority follow-up, and renewal assistance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Trade License Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Trade License applications are generally filed with the municipal corporation, municipality, panchayat, or other competent local body having jurisdiction over the business premises. The exact form, fee, inspection, and documentation vary by state and local authority.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After verification and any required inspection, the authority may issue the Trade License for the permitted activity and premises. The license should be kept valid and renewed as required by the issuing authority.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Our compliance desk reviews your business and premises documents, prepares the application set, and assists with local authority filing and follow-up.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  desc: 'A valid Trade License helps demonstrate that the business has obtained the required local permission for the approved activity and premises.'
                },
                {
                  title: 'Premises & Activity Authorization',
                  desc: 'A valid local business license can improve credibility with customers, landlords, vendors, marketplaces, and other institutions that request business compliance documents.'
                },
                {
                  title: 'Simple Application Support',
                  desc: 'Get professional document review and filing assistance with a ₹999 professional fee; government fees and timelines depend on the local authority.'
                },
                {
                  title: 'Premises & Activity Authorization',
                  desc: 'The license records the approved business activity and premises under the rules of the issuing municipal or local authority.'
                },
                {
                  title: 'Supports Other Compliance',
                  desc: 'Trade License documentation may support other business compliance processes, depending on the registration or authority involved.'
                },
                {
                  title: 'Renewable Local Permission',
                  desc: 'Trade Licenses generally have a validity period and can be renewed according to the rules, due dates, and fees prescribed by the issuing authority.'
                }
              ].map((item, idx) => (
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Applying for a Trade License
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Confirm Local Jurisdiction',
                  desc: 'Identify the municipal corporation, municipality, panchayat, or other local body that has jurisdiction over your business premises.'
                },
                {
                  title: 'Identify Business Activity',
                  desc: 'Clearly identify the trade, service, shop, office, restaurant, workshop, warehouse, or other commercial activity for which the license is required.'
                },
                {
                  title: 'Keep Business Constitution Proof Ready',
                  desc: 'Keep available the applicable proprietorship, partnership, LLP, company, or other constitution documents for the business.'
                },
                {
                  title: 'Valid Applicant KYC',
                  desc: 'Prepare the applicant or authorized signatory\'s PAN, Aadhaar or other accepted identity/address proof and active contact details.'
                },
                {
                  title: 'Business Premises Address Proof',
                  desc: 'Prepare a recent utility bill, property tax receipt, rent/lease agreement, ownership proof, and NOC where required for the business premises.'
                },
                {
                  title: 'Identify Jurisdiction & Business Activity',
                  desc: 'If the premises are rented, leased, shared, or not owned by the applicant, keep the owner consent or NOC ready where required by the local authority.'
                },
                {
                  title: 'Check Additional NOCs',
                  desc: 'Depending on the business activity, additional permissions such as Fire NOC, FSSAI, Pollution Control consent, or other sectoral approvals may be required.'
                },
                {
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Trade License eligibility depends on the local authority, nature of business, premises, zoning or land-use rules, and activity-specific requirements. The applicant must provide valid KYC, business constitution details, and acceptable premises documents.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The proposed activity should be permissible at the stated premises and should fall within the categories licensed by the local authority.'
                },
                {
                  title: 'Eligible Applicant or Authorized Signatory',
                  desc: 'The proprietor, partner, director, authorized signatory, or other eligible applicant must provide the required identity and authorization documents.'
                },
                {
                  title: 'Valid Business Premises',
                  desc: 'The premises should have valid occupancy, ownership, rent/lease, or other acceptable proof and comply with applicable local usage requirements.'
                },
                {
                  title: 'Required Business Documents',
                  desc: 'The business should have the constitution and authorization documents applicable to its legal form, such as proprietorship proof, partnership deed, LLP or company documents.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The business must provide a valid operating address with acceptable proof and landlord or owner NOC where required.'
                },
                {
                  title: 'Activity-Specific Approvals',
                  desc: 'Certain businesses may need additional approvals or NOCs before or along with the Trade License, depending on the local rules and activity.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions reviews applicant KYC, business constitution, premises documents, and activity details before filing to reduce avoidable application errors.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process a Trade License application, the local authority commonly asks for applicant KYC, business constitution proof, premises documents, photographs, NOC or owner consent where applicable, and activity-specific supporting documents. Exact requirements vary by jurisdiction.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Applicant Identity Proof (PAN / Aadhaar)',
                  desc: 'PAN, Aadhaar, Voter ID, Passport, or other identity documents accepted by the issuing authority for the proprietor or authorized applicant.'
                },
                {
                  title: 'Applicant Address Proof',
                  desc: 'Aadhaar, Voter ID, Passport, utility bill, or other acceptable address proof as required by the local authority.'
                },
                {
                  title: 'Business Premises Address Proof',
                ...
                },
                {
                  ...
                  desc: 'Proprietorship proof, partnership deed, LLP incorporation documents, company incorporation documents, or other constitution proof as applicable.'
                },
                {
                  title: 'akshayb2bsolutions Document Support & Formatting',
                  desc: 'Our compliance team helps organize application forms, NOC drafts, declarations, authorization documents, and supporting papers according to the local authority requirements.'
                }
              ].map((item, idx) => (
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Identify Jurisdiction & Business Activity',
                  desc: 'We identify the applicable municipal or local authority and map the business activity for the correct Trade License application route.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect KYC & Premises Documents',
                  desc: 'Provide applicant KYC, business constitution proof, address proof, rent or ownership documents, NOC where required, and activity-specific papers.'
                },
                {
                  step: 'Step 3',
                  title: 'Document Review & Application Preparation',
                  desc: 'Our team reviews the documents, checks common deficiencies, and prepares the Trade License application details for submission.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit to Municipal / Local Authority',
                  desc: 'The application and supporting documents are submitted to the competent local authority according to the applicable filing process.'
                },
                {
                  step: 'Step 5',
                  title: 'Verification / Inspection Support',
                  desc: 'If the authority raises a query or requires premises verification or inspection, we guide you on the response and supporting documents.'
                },
                {
                  step: 'Step 6',
                  title: 'Trade License Issuance',
                  desc: 'After approval, receive the Trade License or municipal authorization and guidance on validity, display, amendment, and renewal requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status & Scope of a Trade License
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  A Trade License is an operational permission issued for a specified business activity and premises. It does not create a separate legal entity and does not replace business incorporation or tax registrations.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Compliance may include timely renewal, displaying or keeping the license available as required, maintaining premises and safety conditions, and updating the authority when key particulars change.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  A Trade License supports lawful local operations for the approved activity, but it is limited to the issuing jurisdiction, premises, activity, and validity stated by the authority.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The license holder remains responsible for complying with municipal conditions, public health, safety, nuisance-control, and other applicable local requirements.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our advisors help explain the applicable local authority, documentation, permitted activity, validity, amendment, renewal, and related business registrations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After obtaining a Trade License, businesses should comply with the conditions of the issuing authority and complete renewal or amendment requirements on time to avoid penalties or enforcement action.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Trade License Validity & Renewal',
                  desc: 'Track the validity period and apply for renewal within the timeline prescribed by the issuing municipal or local authority.'
                },
                {
                  title: 'Display / Availability of License',
                  desc: 'Keep the Trade License certificate available at the business premises and display it where the local authority requires.'
                },
                {
                  title: 'Maintain Approved Business Activity',
                  desc: 'Operate only the activity and premises covered by the license unless an amendment, endorsement, or fresh approval is obtained.'
                },
                {
                  title: 'Report Changes to Local Authority',
                  desc: 'Report or apply for amendment for changes in business name, ownership, premises, activity, or other particulars where required.'
                },
                {
                  title: 'Maintain Other Applicable Registrations',
                  desc: 'Keep GST, FSSAI, Shop & Establishment, Fire NOC, Pollution Control, or other applicable registrations valid where required.'
                },
                {
                  title: 'Labour Law Compliance (EPF/ESI)',
                  desc: 'Comply with labour, employee welfare, health, safety, fire, and environmental requirements applicable to your establishment.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Trade License vs Other Business Registrations
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold border-r border-blue-800">Shop &amp; Establishment</th>
                    <th className="p-3.5 font-bold">FSSAI Registration</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Municipal / Local Body Rules
                    </td>
                    <td className="p-3.5 border-r border-slate-200">CGST / SGST Acts & Rules</td>
                    <td className="p-3.5 border-r border-slate-200">Applicable State Shops Law</td>
                    <td className="p-3.5">Food Safety and Standards Act / Regulations</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Eligible Taxable Person</td>
                    <td className="p-3.5 border-r border-slate-200">Employer / Establishment</td>
                    <td className="p-3.5">Food Business Operator</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-rose-700 border-r border-slate-200">
                      Not a Liability Structure
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Not a Liability Structure</td>
                    <td className="p-3.5 border-r border-slate-200">Not a Liability Structure</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Not a Liability Structure</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">GST Compliance Applies</td>
                    <td className="p-3.5 border-r border-slate-200">Not a Tax Registration</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Not a Tax Registration</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Depends on Business Entity</td>
                    <td className="p-3.5 border-r border-slate-200">Depends on Establishment</td>
                    <td className="p-3.5">Depends on Business Entity</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 border-r border-slate-200">6. Compliance Burden</td>
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Returns / Tax Compliance
                    </td>
                    <td className="p-3.5 border-r border-slate-200">State-wise Compliance</td>
                    <td className="p-3.5 border-r border-slate-200">State-wise Renewal / Updates</td>
                    <td className="p-3.5">Food Safety Compliance</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 border-r border-slate-200">Employment / Establishment Compliance</td>
                    <td className="p-3.5 border-r border-slate-200">Local Establishment Compliance</td>
                    <td className="p-3.5 text-orange-800 font-semibold">Food Business Compliance</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-slate-900 border-r border-slate-200">
                      Local Shops, Offices & Businesses
                    </td>
                    <td className="p-3.5 border-r border-slate-200">Businesses Liable for GST</td>
                    <td className="p-3.5 border-r border-slate-200">Shops, Offices & Establishments</td>
                    <td className="p-3.5">Food Businesses</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & Compliance Impact of a Trade License
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              A Trade License is not an income-tax or GST registration. It is a local business permission. Tax obligations continue to depend on the business constitution, turnover, nature of supplies, and applicable tax laws.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Trade License Is Not a Tax Registration',
                  desc: 'Obtaining a Trade License does not by itself determine income-tax liability, GST registration, or tax rates.'
                },
                {
                  title: 'GST May Be Separately Applicable',
                  desc: 'GST registration and returns are separate compliances and depend on turnover, business activity, place of supply, and other GST rules.'
                },
                {
                  title: 'Income Tax Applicant / Business Entity',
                  desc: 'Income-tax treatment depends on whether the business is a proprietorship, partnership, LLP, company, or other entity and on applicable tax provisions.'
                },
                {
                  title: 'Professional Fee Separate from Government Fee',
                  desc: 'Our professional service fee is ₹999. Government, municipal, inspection, or activity-based fees are additional and depend on the local authority.'
                },
                {
                  title: 'Renewal Fee May Apply',
                  desc: 'The issuing authority may prescribe periodic renewal charges, late fees, penalties, or amendment fees depending on the jurisdiction.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team can help coordinate Trade License, GST, Udyam, Shop & Establishment, FSSAI, and other applicable business registrations.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              A Trade License does not itself provide financing, but maintaining proper business registrations can support credibility when applying for bank facilities, vendor credit, MSME schemes, or other business finance.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible businesses may apply for working capital, term loans, or overdraft facilities subject to lender requirements and credit assessment.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Banks may ask for business KYC and registration documents, and a valid Trade License can form part of the compliance documentation where applicable.'
                },
                {
                ...
                {
                  title: 'Equity & Investor Funding',
                  desc: 'Investor or equity funding depends on the legal structure of the business and applicable company, LLP, securities, and foreign investment rules, not on the Trade License itself.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We review your business activity, premises, city, and local jurisdiction to identify the likely Trade License application route and required documents.'
                },
                {
                  title: 'Application Preparation & Document Verification',
                  desc: 'Our compliance specialists review KYC, premises proof, NOC, constitution documents, and application details to reduce avoidable filing errors.'
                },
                {
                  title: 'Municipal / Local Authority Follow-Ups',
                  desc: 'We assist with filing follow-up, authority queries, and additional-document requests during the Trade License process.'
                },
                {
                  title: 'Query & Inspection Guidance',
                  desc: 'If the authority requires clarification, verification, or premises inspection, we guide you on the documents and response process.'
                },
                {
                  title: 'Renewal & Amendment Support',
                  desc: 'Get guidance for Trade License renewal, address or activity changes, amendments, and related local compliance requirements.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Zero hidden professional charges: Trade License assistance at ₹999, with government or municipal fees shown separately as applicable.',
                  icon: Tag
                },
                {
                  title: 'Trusted by Thousands',
                  desc: 'Professional support for business registration and compliance requirements across India, subject to local jurisdiction and authority availability.',
                  icon: Users
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your KYC, business records, and application documents.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Apply for Your Trade License with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Get professional Trade License application support with document review, local authority filing guidance, transparent pricing, and dedicated assistance.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start Trade License at ₹999 + Govt. Fees
              </button>
              <button
