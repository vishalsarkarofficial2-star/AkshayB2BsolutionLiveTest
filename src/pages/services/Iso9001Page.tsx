...
// 6 Accordion FAQs (adapted from the Indian organisation Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is ISO 9001 Certification?', a: 'ISO 9001 is an internationally recognised Quality Management System (QMS) standard focused on consistent processes, customer satisfaction, risk-based thinking, continual improvement and effective quality controls.' },
  { q: 'Who can apply for ISO 9001?', a: 'ISO 9001 can be implemented by businesses of almost any size or sector, including manufacturers, service providers, traders, startups, agencies, healthcare, education and professional firms.' },
  { q: 'What documents are generally required?', a: 'Typical requirements may include business registration proof, PAN/GST details where applicable, address proof, organisation structure, process information, quality policy/objectives and other records needed to build or review the QMS.' },
  { q: 'How long does ISO 9001 certification take?', a: 'The timeline depends on organisation size, process complexity, documentation readiness and audit scheduling. A practical turnaround can range from a few working days to several weeks.' },
  { q: 'Does ISO 9001 improve business credibility?', a: 'Yes. Certification can strengthen customer confidence, support vendor onboarding, tenders and B2B sales, and demonstrate that the business follows a structured quality-management approach.' },
  { q: 'Is ISO 9001 certification valid forever?', a: 'No. Certification is generally subject to a certification cycle with periodic surveillance and renewal requirements depending on the certification body and applicable audit programme.' }
]

// Related services cross-linking items — sourced from organisation-adjacent structures
const RELATED_SERVICES = [
  { title: 'ISO 14001 Certification', desc: 'Environmental Management System certification support for organisations focused on environmental performance and compliance.', img: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'ISO 45001 Certification', desc: 'Occupational Health & Safety Management System certification support for safer workplaces.', img: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'ISO 22000 Certification', desc: 'Food Safety Management System certification support for eligible food businesses.', img: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'ISO 27001 Certification', desc: 'Information Security Management System certification support for data and cyber-security focused organisations.', img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible micro, small and medium enterprises.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: '₹499' },
  { title: 'GST Registration', desc: 'GST registration support for eligible businesses across India.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: '₹699' },
  { title: 'Trademark Registration', desc: 'Protect your business name, logo and brand identity through trademark filing support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: '₹1,499 Quality Management Supports' },
  { title: 'Startup India Registration', desc: 'Get Startup India recognition support for eligible innovative businesses.', img: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'BIS Registration', desc: 'Get compliance guidance for eligible products requiring BIS registration or certification in India.', img: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]

export const Iso9001Page: React.FC<Iso9001PageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('ISO 9001 Certification Package (₹2,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ISO 9001 Certification</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India ISO Certification Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Quick QMS Documentation Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional QMS documentation & certification assistance
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  ISO 9001 Certification in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an organisation may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Dedicated ISO Consultant</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>POPULAR QUALITY PACKAGE</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based ISO consultant has been assigned to your certification request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of ISO 9001 Certification *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your state, organisation type and business activity help us understand the operating context and prepare the QMS documentation requirements appropriately.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why choose akshayb2bsolutions for ISO 9001?</span>
                              </div>
                              <p className="text-[11px]">
                                Get process review, QMS documentation guidance, quality policy/objective support, audit-readiness assistance and certification coordination with minimal complexity.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Business PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ISO 9001 Certification Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ISO 9001 Certification Package (₹2,999)">ISO 9001 Certification Package — ₹2,999 Quality Management Supports</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start ISO 9001 Process</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'comparison', label: 'ISO 9001 vs Others' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple, Transparent ISO Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                ISO 9001 Certification Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One clear package designed for businesses that want structured QMS documentation, ISO readiness support and certification coordination without unnecessary complexity.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">ISO 9001 Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for startups, SMEs, manufacturers and service businesses that want to strengthen quality processes, improve credibility and support tenders or B2B onboarding.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'QMS Gap Review & Documentation Guidance',
                      'Quality Policy & Objective Support',
                      'Audit Coordination Guidance Support',
                      'Internal Readiness & Audit Preparation Support',
                      'Certification Body Coordination Guidance',
                      'Dedicated ISO 9001 Consultant Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ISO 9001 Certification Package (₹2,999)');
                ...
                >
                  Get Started with ISO 9001 Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              ISO 9001 is a quality-management standard that helps organisations define processes, responsibilities, quality objectives, customer-focused controls and continual-improvement practices. Certification demonstrates that these systems have been implemented and reviewed against the standard.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for manufacturers, service providers, traders, startups, agencies, healthcare organisations, educational institutions and other businesses seeking stronger quality systems and market credibility.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A practical QMS clarifies how work is performed, monitored and improved so the business can deliver more consistent results to customers.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Certification scope should accurately reflect the organisation's activities, locations and services so the certificate is commercially useful and aligned with operations.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  ISO 9001 is typically voluntary, but many customers, corporates, vendor panels and tenders prefer or require suppliers to demonstrate recognised quality-management practices.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A well-implemented QMS can reduce process variation, improve accountability, strengthen customer confidence and support business growth.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, organisation registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How ISO 9001 Certification Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              organisation registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the organisation registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Stronger Customer Confidence', desc: 'Demonstrate a structured approach to quality, consistency and customer satisfaction.' },
                { title: 'Better Process Control', desc: 'Define responsibilities, workflows and controls so teams work more consistently.' },
                { title: 'Support for Tenders & Vendor Onboarding', desc: 'ISO 9001 can strengthen eligibility and credibility in many B2B, procurement and tender situations.' },
                { title: 'Reduced Errors & Rework', desc: 'Process documentation and review can help identify recurring issues and improve operational discipline.' },
                { title: 'Continual Improvement Culture', desc: 'The standard encourages monitoring, corrective action and evidence-based improvement.' },
                { title: 'Stronger Business Image', desc: 'Certification can improve brand perception with customers, partners and institutional buyers.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before ISO 9001 Certification
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Define Certification Scope', desc: 'Clearly identify the products, services, sites and activities to be covered by the QMS.' },
                { title: 'Map Key Business Processes', desc: 'Identify sales, operations, purchasing, delivery, quality checks, customer service and other core workflows.' },
                { title: 'Assign Roles & Responsibilities', desc: 'Define who owns each process and who is responsible for quality controls and records.' },
                { title: 'Prepare Quality Policy & Objectives', desc: 'Create practical quality commitments and measurable objectives aligned with business goals.' },
                { title: 'Maintain Required Records', desc: 'Keep evidence of process monitoring, complaints, corrective actions, training and other relevant controls.' },
                { title: 'Review Risks & Opportunities', desc: 'Identify issues that could affect quality and define practical controls.' },
                { title: 'Conduct Internal Readiness Review', desc: 'Check whether the QMS is working before the certification audit.' },
                { title: 'Prepare for Certification Audit', desc: 'Ensure documents, records and responsible team members are ready for auditor review.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To register a organisation in India, there must be a minimum of two management / authorised persons and a maximum of twenty. All management / authorised persons must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen organisation structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected organisation structure.'
                },
                {
                  title: 'Unique organisation Name Requirement',
                  desc: 'The organisation must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written organisation Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the organisation objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The organisation must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a organisation.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your organisation registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Business Registration Proof', desc: 'Company, LLP, partnership, proprietorship or other legal constitution proof, as applicable.' },
                { title: 'PAN / GST / Business Details', desc: 'Basic tax and business identification details where applicable.' },
                { title: 'Office / Site Address Proof', desc: 'Address details of the location covered within the proposed certification scope.' },
                { title: 'Organisation Structure & Roles', desc: 'Basic information about management responsibilities and operational teams.' },
                { title: 'Process & Service Information', desc: 'Details of the products, services and key operational processes to be covered.' },
                { title: 'Existing Policies / SOPs / Records', desc: 'Any existing quality documents, checklists, procedures, customer records or process evidence available for review.' }
              ...
              {[
                {
                  ...
                  desc: 'We prepare the appropriate governing document detailing the organisation objectives, management team, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique organisation Name',
                  desc: 'Our team helps check the proposed organisation name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped organisation deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the organisation\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the organisation registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the organisation bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an organisation depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the organisation structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate organisation structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, organisations must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the organisation\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered organisation name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual organisation Compliance & Tax Filing',
                  desc: 'File the organisation\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the organisation employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on organisation structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Important ISO 9001 Considerations
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              organisation tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on organisation Structure',
                  desc: 'Tax liability and exemptions depend on whether the organisation is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible organisations must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working management / authorised persons are taxable in the authorised person\'s hands but deductible for the organisation, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible organisations should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the organisation structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Where ISO 9001 Adds Business Value
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              organisations generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible organisations may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, organisations may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an organisation; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Our compliance specialists draft a legally sound organisation deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Improve Quality. Build Trust. Grow.
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Get ISO 9001 with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their organisation with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
