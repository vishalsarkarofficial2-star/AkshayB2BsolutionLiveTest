...
interface TrademarkHearingPageProps {
  onBackToHome: () => void;
...
const FAQ_ITEMS = [
  { q: 'What is a Trademark Hearing in India?', a: 'A trademark hearing is an opportunity before the Trade Marks Registry to present arguments and supporting material when an application has not been accepted through the ordinary examination process or when a hearing has been scheduled.' },
  { q: 'Why is a trademark hearing scheduled?', a: 'A hearing may be scheduled where objections raised by the Registry remain unresolved after examination or reply, or where the Registrar considers oral submissions necessary before deciding the application.' },
  { q: 'What documents are commonly needed for a hearing?', a: 'Common documents may include the examination report, objection reply, hearing notice, trademark application details, user evidence, invoices, advertisements, website screenshots, registration certificates, authorization documents, and other material relevant to the case.' },
  { q: 'Can a trademark hearing be attended online?', a: 'The mode of hearing depends on the Registry notice and current Trade Marks Registry procedure. Hearings may be conducted through the mode specified by the Registry.' },
  { q: 'What happens after the hearing?', a: 'After considering the submissions and record, the Registrar may accept the application, impose conditions, seek clarification, or pass an order adverse to the application depending on the case.' },
  { q: 'Do you guarantee trademark approval after hearing?', a: 'No professional can guarantee approval because the final decision rests with the Trade Marks Registry. Our role is to prepare the case carefully and present the strongest support available from the documents and facts.' }
]

// Related services cross-linking items — sourced from trademark-adjacent structures
const RELATED_SERVICES = [
  { title: 'Trademark Objection Reply', desc: 'Professional drafting and filing support for examination objections before the matter reaches hearing.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Trademark Registration', desc: 'Protect your brand name or logo with professional trademark filing support in India.', img: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=600&auto=format&fit=crop&q=80', price: '₹1,499 Case-Based Assistances' },
  { title: 'Trademark Opposition', desc: 'Legal support for filing or defending a trademark opposition with evidence and written submissions.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Trademark Renewal', desc: 'Renew your registered trademark and maintain ongoing statutory protection.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Trademark Rectification', desc: 'Support for rectification or cancellation-related trademark proceedings where applicable.', img: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Copyright Registration', desc: 'Protect eligible original creative works, artwork, software and content.', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Brand Name Registration', desc: 'Get help protecting your brand name through trademark application filing.', img: 'https://images.unsplash.com/photo-1558655146-d09347e92766?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Trademark Search', desc: 'Check for similar marks and identify potential conflict risks before filing.', img: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'IP Legal Consultation', desc: 'Get guidance on trademark objections, hearings, opposition and brand-protection strategy.', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]

export const TrademarkHearingPage: React.FC<TrademarkHearingPageProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Individual / Proprietor');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Trademark Hearing Support Package (Custom Quote)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Trademark Hearing</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Trademark Hearing Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Case Review & Hearing Preparation</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Prepare your trademark hearing with{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Hearing-focused legal & filing assistance
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Trademark Hearing in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an trademark may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Hearing Notice Review</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Written Submission Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Trade Marks Registry Support</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Users2 className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>Dedicated Trademark Specialist</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>CASE REVIEW PRIORITY</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based trademark specialist has been assigned to your hearing case. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            scope depends on notice & case record
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Trademark Hearing *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your application details, hearing notice and Registry record help us assess the correct hearing strategy and documentation required.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why prepare your hearing with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get hearing notice review, case analysis, evidence organization, written submission support and expert guidance with a clear step-by-step process.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Trademark Hearing Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Trademark Hearing Support Package (Custom Quote)">Trademark Hearing Support Package — Custom Case Quote</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Request Hearing Review</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Hearing Process' },
                { id: 'advantages', label: 'Why Preparation Matters' },
                { id: 'checklist', label: 'Checklist' },
                { id: 'eligibility', label: 'When Needed' },
                { id: 'documents', label: 'Documents Required' },
                { id: 'steps', label: 'Steps' },
                { id: 'legal-status', label: 'Legal Position' },
                { id: 'post-compliance', label: 'After Hearing' },
                { id: 'comparison', label: 'Reply vs Hearing' },
                { id: 'tax-implications', label: 'Strategy Points' },
                { id: 'financing', label: 'Common Scenarios' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Focused Trademark Hearing Support
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                Trademark Hearing Support Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package for applicants who have received a trademark hearing notice and need structured case preparation, document review and professional hearing support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Trademark Hearing Support</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Designed for applicants who want their hearing notice, objection history, evidence and submissions reviewed before appearing before the Trade Marks Registry.
                  </p>
                  ...
                  <div className="mb-6 pb-6 border-b border-slate-100">
                    ...
                    <span className="text-xs text-slate-500 font-medium block mt-1">
                      Pricing determined by hearing notice & case complexity
                    </span>
                  </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Hearing Notice & Examination History Review',
                      'Trademark Objection & Reply Analysis',
                      'Trade Marks Registry Support Support',
                      'Evidence & Supporting Document Organization',
                      'Hearing Preparation & Registry Process Guidance',
                      'Dedicated Trademark Hearing Specialist Support'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Trademark Hearing Support Package (Custom Quote)');
                ...
                >
                  Get Started with Trademark Hearing Support
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A trademark hearing is a formal opportunity to address unresolved Registry concerns and explain why the application should proceed. Effective preparation usually requires reviewing the examination report, reply already filed, hearing notice, supporting evidence and the legal basis of the mark.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for trademark applicants whose application has reached the hearing stage after examination, objection reply or further Registry review.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A hearing gives the applicant an opportunity to clarify legal and factual issues, explain distinctiveness, address cited marks and place supporting material before the Registry.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The quality of the hearing record matters because the Registrar will consider the application, objections, prior submissions, evidence and arguments before passing an order.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Missing the hearing date or presenting an incomplete case can seriously affect the application, so the notice and deadlines should be reviewed immediately.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Professional preparation helps organize the facts, documents and legal points into a clear case rather than relying on last-minute oral explanation.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, trademark registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Trade Marks Registry Process
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Trademark Hearing Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              trademark registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the trademark registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Professional Hearing Preparation Matters
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Stronger Case Presentation', desc: 'Organize the application history, objection, reply and evidence into a clear hearing strategy.' },
                { title: 'Focused Legal Arguments', desc: 'Prepare arguments around distinctiveness, cited marks, usage and the exact grounds raised by the Registry.' },
                { title: 'Better Evidence Readiness', desc: 'Identify useful invoices, advertisements, website evidence, packaging, registrations and other supporting documents.' },
                { title: 'Reduce Hearing-Day Confusion', desc: 'Know what issues are likely to be discussed and what documents should be readily available.' },
                { title: 'Clear Registry Process Guidance', desc: 'Understand the hearing stage, possible outcomes and what may happen after the hearing.' },
                { title: 'Dedicated Trademark Support', desc: 'Get structured assistance from case review through hearing preparation and post-hearing follow-up.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Your Trademark Hearing
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Keep the Hearing Notice Ready', desc: 'Confirm the hearing date, application number, Registry office and any instructions mentioned in the notice.' },
                { title: 'Review the Examination Report', desc: 'Identify the exact absolute or relative grounds originally raised by the Registry.' },
                { title: 'Review the Objection Reply Already Filed', desc: 'Ensure the hearing arguments remain consistent with the written reply and application record.' },
                { title: 'Collect Evidence of Brand Use', desc: 'Keep invoices, advertisements, packaging, website screenshots and social-media use where relevant.' },
                { title: 'Collect Supporting Registrations', desc: 'Keep related trademark registrations, company records, domain records or other documents that support ownership and use.' },
                { title: 'Identify Cited / Conflicting Marks', desc: 'Understand the marks referred to in the examination report and prepare distinctions where possible.' },
                { title: 'Prepare a Clear Case Summary', desc: 'Summarize facts, legal grounds, usage history and the relief requested from the Registry.' },
                { title: 'Complete Pre-Hearing Review', desc: 'Our team reviews the record and organizes the material before the scheduled hearing.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To register a trademark in India, there must be a minimum of two applicants / authorised persons and a maximum of twenty. All applicants / authorised persons must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Applicants / Authorised Persons',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen trademark structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected trademark structure.'
                },
                {
                  title: 'Unique trademark Name Requirement',
                  desc: 'The trademark must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written trademark Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the trademark objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The trademark must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a trademark.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each applicant\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your trademark registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Trademark Hearing Notice', desc: 'Copy of the hearing notice containing the application number, hearing date and Registry details.' },
                { title: 'Trademark Application & Examination Report', desc: 'Application particulars and the examination report showing the objections raised.' },
                { title: 'Objection Reply / Written Response', desc: 'Copy of the response already filed against the examination report.' },
                { title: 'Applicant KYC / Entity Proof', desc: 'Identity and business constitution documents of the trademark applicant, where relevant.' },
                { title: 'Evidence of Use', desc: 'Invoices, labels, packaging, advertisements, website screenshots, social media evidence or sales material, if relied upon.' },
                { title: 'Authorization & Supporting Legal Documents', desc: 'Power of attorney / authorization, cited registrations, related brand documents and any other material relevant to the hearing.' }
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-4">
              {[
                { step: 'Step 1', title: 'Share Hearing Notice & Application Details', desc: 'Send the hearing notice, application number, examination report and any reply already filed.' },
                { step: 'Step 2', title: 'Case Review & Issue Identification', desc: 'We identify the exact objections, weak points, supporting facts and documents relevant to the hearing.' },
                { step: 'Step 3', title: 'Evidence & Document Preparation', desc: 'We organize use evidence, registrations, brand material and supporting records in a structured manner.' },
                { step: 'Step 4', title: 'Prepare Written Arguments / Hearing Notes', desc: 'Key legal and factual points are prepared for clear presentation before the Registry.' },
                { step: 'Step 5', title: 'Hearing Preparation & Coordination', desc: 'We help prepare for the scheduled hearing and coordinate the representation workflow as applicable.' },
                { step: 'Step 6', title: 'Post-Hearing Status Guidance', desc: 'After hearing, we guide you on order/status tracking and any next procedural step that may arise.' }
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Position During Trademark Hearing
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an trademark depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the trademark structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a applicant\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate trademark structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                After Hearing Compliance Checklist
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, trademarks must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the trademark\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered trademark name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual trademark Compliance & Tax Filing',
                  desc: 'File the trademark\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the trademark employs staff.'
                },
                {
        ...
        <section id="comparison" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Objection Reply vs Trademark Hearing
              </h2>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Applicants / Authorised Persons
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Applicants / Authorised Persons</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on trademark structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Applicants / Authorised Persons
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Key Hearing Strategy Points
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              trademark tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on trademark Structure',
                  desc: 'Tax liability and exemptions depend on whether the trademark is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible trademarks must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working applicants / authorised persons are taxable in the applicant\'s hands but deductible for the trademark, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible trademarks should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the trademark structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Common Trademark Hearing Scenarios
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              trademarks generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible trademarks may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, trademarks may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an trademark; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your applicants / authorised persons\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound trademark deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                ...
                {
                  title: 'Dedicated After Hearing Growth Advisory',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your applicants / authorised persons\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Prepare Your Trademark Hearing
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Face Your Trademark Hearing with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their trademark with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
