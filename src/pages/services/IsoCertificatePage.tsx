...
interface ISOCertificateLandingProps {
  onBackToHome: () => void;
...
const FAQ_ITEMS = [
  { q: 'What is an ISO Certificate?', a: 'An ISO certificate is issued by an independent certification body after assessing whether an organization meets the requirements of a specific ISO management-system standard, such as ISO 9001, ISO 14001, ISO 45001 or ISO 27001. ISO itself develops standards but does not certify organizations.' },
  { q: 'Which ISO certification is right for my business?', a: 'The right standard depends on your goals and operations. ISO 9001 focuses on quality management, ISO 14001 on environmental management, ISO 45001 on occupational health and safety, ISO 27001 on information security, and other standards apply to specific sectors and needs.' },
  { q: 'What is included in the ₹1,999 ISO assistance package?', a: 'The package includes initial standard selection guidance, basic gap review, documentation checklist, implementation guidance, internal-audit readiness support and certification-process coordination. Independent certification-body or audit charges, if any, depend on the selected standard and organization scope.' },
  { q: 'Can small businesses and MSMEs get ISO certified?', a: 'Yes. ISO management-system standards can be implemented by organizations of different sizes, including MSMEs, startups, factories, service providers, traders, contractors and professional firms.' },
  { q: 'How long does ISO certification take?', a: 'The timeline depends on the standard selected, organization size, number of locations, process complexity, existing documentation, implementation readiness and certification-body scheduling.' },
  { q: 'Does ISO itself issue the certificate?', a: 'No. ISO publishes international standards. Certification is carried out by independent certification bodies. Our role is to help you prepare, document, implement and coordinate the certification process.' }
]
...
const RELATED_SERVICES = [
  {
    ...
    desc: 'Quality management certification support focused on consistent processes, customer satisfaction and continual improvement.',
  ...
  },
  {
    ...
    desc: 'Environmental management certification support for stronger environmental controls and sustainability practices.',
    img: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'ISO 45001 Certification',
    desc: 'Occupational health and safety management certification support for safer workplaces and stronger risk controls.',
    img: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'ISO 27001 Certification',
    desc: 'Information security management certification support for protecting data, systems and business information.',
    img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'ISO 22000 Certification',
    desc: 'Food safety management certification support for food businesses, processors and supply-chain organizations.',
    img: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'ISO 13485 Certification',
    desc: 'Quality-management certification support for organizations involved in medical devices and related activities.',
    img: 'https://images.unsplash.com/photo-1584982751601-97dcc096659c?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'HACCP Certification Support',
    desc: 'Food-safety hazard analysis and preventive control certification support for eligible food businesses.',
    img: 'https://images.unsplash.com/photo-1556761223-4c4282c73f77?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'GMP Certification Support',
    desc: 'Good Manufacturing Practice documentation and certification support for applicable manufacturing businesses.',
    img: 'https://images.unsplash.com/photo-1581093458791-9d42e3c4b3f3?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'CE Marking Support',
    desc: 'Documentation and conformity support for businesses dealing with applicable European product requirements.',
    img: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  }
]

export const IsoCertificatePage: React.FC<ISOCertificateLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
...
export const ISOCertificateLanding: React.FC<ISOCertificateLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [selectedPackage, setSelectedPackage] = useState('ISO Certificate Assistance Package (₹1,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">ISO Certificate</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start Your ISO Certification Journey at{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      Professional ISO certification assistance for Indian businesses
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  ISO Certificate in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an organization may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>ISO Support at ₹1,999</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our ISO certification specialist has been assigned to your assistance request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            (documentation & audit-readiness assistance)
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of ISO Certificate *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your location and business activity help us understand your certification scope and assign the right ISO assistance specialist.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              ...
                              <p className="text-[11px]">
                                Get standard-selection guidance, document checklist, implementation support, internal-audit readiness and certification-process coordination with minimal confusion.
                              </p>
                            </div>
                          </div>
                        )}
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                placeholder="Owner / manager / authorized person"
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select ISO Certificate Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="ISO Certificate Package (₹1,999)">ISO Certificate Package — ₹1,999 Complete Supports</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start ISO Assistance</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Certification Process' },
                { id: 'advantages', label: 'Benefits' },
                { id: 'checklist', label: 'Checklist' },
                { id: 'eligibility', label: 'Who Can Apply' },
                { id: 'documents', label: 'Documents Required' },
                { id: 'steps', label: 'Steps' },
                { id: 'legal-status', label: 'ISO Standards' },
                { id: 'post-compliance', label: 'After Certification' },
                { id: 'comparison', label: 'ISO Comparison' },
                { id: 'tax-implications', label: 'Validity & Audits' },
                { id: 'financing', label: 'Business Value' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple ISO Certification Assistance
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0D47A1] mt-2">
                ISO Certificate Assistance Package
              </h2>
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One practical package for businesses that want help choosing the right ISO standard, preparing documents and getting ready for certification assessment.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    ...
                    <span className="px-3 py-1 rounded bg-yellow-100 text-yellow-900 text-[10px] font-black uppercase tracking-wide">
                      ₹1,999 ASSISTANCE PACKAGE
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#0D47A1]">Complete ISO Certificate Assistance</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for MSMEs, startups, factories, traders, contractors, service providers and growing companies that need structured ISO certification support.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'ISO Standard Selection & Initial Gap Review',
                      'Documentation Checklist & Template Guidance',
                      'Audit Coordination Support',
                      'Internal Audit & Management Review Readiness',
                      'Certification Audit Coordination Support',
                      'Dedicated ISO Certification Advisor'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('ISO Certificate Package (₹1,999)');
                ...
                >
                  Get Started with Complete ISO Certificate Assistance
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              An ISO certificate confirms that an independent certification body has assessed an organization against a selected ISO management-system standard. Different standards focus on different goals, such as quality, environmental performance, workplace safety, information security or food safety.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Who It Is For:</strong>
                  MSMEs, startups, manufacturers, contractors, exporters, service providers, professional firms, warehouses, food businesses and established companies looking to strengthen systems and customer confidence.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Choose the Right Standard:</strong>
                  ISO 9001, ISO 14001, ISO 45001, ISO 27001 and other standards address different business needs. Selecting the correct standard is the first step toward a useful certification.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Process-Based Implementation:</strong>
                  The management system should reflect your actual processes, risks, roles and business objectives rather than exist as paperwork only.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Build Customer Confidence:</strong>
                  Certification can support credibility with customers, procurement teams, supply chains and tender requirements where formal management systems matter.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Improve Internal Control:</strong>
                  Documented processes, defined responsibilities, internal audits and management reviews help businesses operate more consistently and identify improvement opportunities.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, ISO certification is most valuable when the standard is implemented practically. Our team helps with standard selection, documentation, implementation readiness and coordination with an independent certification body.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How ISO Certificate Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              The process begins by choosing the right ISO standard and defining the scope. The organization then reviews current processes, prepares or improves required documentation, implements the system and builds evidence that the requirements are working in practice.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After internal readiness activities, an independent certification body may perform the certification audit. ISO itself does not issue certificates. If the audit requirements are met and findings are addressed, the certification body issues the certificate.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#0B3D91] flex items-center gap-1.5">
                ...
                <span>How akshayb2bsolutions Streamlines Certification:</span>
              </h4>
              <p className="text-xs text-slate-600 leading-relaxed">
                We help you choose the relevant standard, understand the scope, prepare the document set, organize internal-audit readiness and coordinate the external certification process.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
              ...
              {[
                {
                  ...
                  desc: 'A recognized management-system certificate can support confidence with customers, vendors and procurement teams.'
                },
                {
                  title: 'More Consistent Processes',
                  desc: 'Documented processes, responsibilities and controls help teams work more consistently and reduce avoidable variation.'
                },
                {
                  title: 'Better Risk Awareness',
                  desc: 'ISO management systems encourage structured identification of business, quality, environmental, safety or information-security risks depending on the selected standard.'
                },
                {
                  title: 'Tender & Vendor Advantage',
                  desc: 'Certification can strengthen your position where buyers or tender documents ask for recognized management-system standards.'
                },
                {
                  title: 'Clear Roles & Responsibilities',
                  desc: 'Management-system standards encourage defined responsibilities, documented controls and measurable objectives across important business processes.'
                },
                {
                  title: 'Continual Improvement',
                  desc: 'Internal audits, corrective action and management review create a repeatable cycle for improving performance over time.'
                }
              ].map((item, idx) => (
            ...
            <p className="text-xs text-slate-500 text-center pt-2">
              akshayb2bsolutions helps translate ISO requirements into practical documentation and audit-ready systems suited to your business.
            </p>
          </div>
        </section>
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Select the Right ISO Standard',
                  desc: 'Choose the ISO standard that matches your business objective, sector, customer requirement or tender need.'
                },
                {
                  title: 'Define Certification Scope',
                  desc: 'Identify the sites, activities, departments, services and processes that will fall within the certification scope.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Prepare policies, procedures, registers, records and evidence required for the chosen standard and certification scope.'
                },
                {
                  title: 'Choose Standard & Define Scope',
                  desc: 'Put the documented processes into practice, maintain records and ensure employees understand relevant procedures and responsibilities.'
                },
                {
                  title: 'Internal Audit & Management Review',
                  desc: 'Conduct internal audit, close important gaps and complete management review before approaching external certification assessment.'
                },
                {
                  title: 'akshayb2bsolutions Readiness Review',
                  desc: 'Our team reviews documentation and implementation readiness so you can approach certification assessment with more confidence.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Businesses and organizations of different sizes and sectors can implement ISO management systems. The correct standard and scope depend on business activities, risks, customer expectations and certification goals.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Small businesses can implement ISO systems scaled to their actual processes and complexity.'
                },
                {
                  title: 'Factories & Manufacturers',
                  desc: 'Manufacturing businesses often use ISO standards to strengthen quality, environment, safety and customer confidence.'
                },
                {
                  title: 'Service Providers & Professionals',
                  desc: 'IT companies, consultants, agencies, healthcare providers and other service organizations can also pursue relevant ISO certification.'
                },
                {
                  title: 'Contractors & Vendors',
                  desc: 'ISO certification can support supplier qualification and customer requirements where management-system controls are expected.'
                },
                {
                  title: 'Single or Multiple Locations',
                  desc: 'Certification scope can cover one location or multiple locations depending on the organization and certification arrangement.'
                },
                {
                  title: 'Industry-Specific Standards',
                  desc: 'Some sectors may benefit from specific standards such as ISO 22000 for food safety or ISO 13485 for medical-device quality management.'
                },
                {
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              The exact document set depends on the ISO standard selected, but the following information and records are commonly needed to prepare for certification.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Scanned copies of each authorized representative\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Management Representatives\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Relevant management-system policy, measurable objectives and responsibilities aligned to the selected ISO standard.'
                },
                {
                  title: 'Process & Risk Records',
                  desc: 'Process maps, risk assessments, operational controls and other standard-specific evidence.'
                },
                {
                  title: 'Procedures & Registers',
                  desc: 'Required procedures, registers, logs, forms and documented information supporting implementation.'
                },
                {
                  title: 'Training, Audit & Review Records',
                  desc: 'Competence or training evidence, internal-audit records, management-review outputs and corrective-action evidence as applicable.'
                },
                {
                  title: 'akshayb2bsolutions Documentation Support',
                  desc: 'We provide structured documentation guidance and templates aligned to the selected ISO standard and your actual business processes.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step ISO Certificate Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Choose Standard & Define Scope',
                  desc: 'We identify the most suitable ISO standard and define the certification scope based on your business and goals.'
                },
                {
                  step: 'Step 2',
                  title: 'Conduct Gap Review',
                  desc: 'Review current processes, documents and evidence against the selected standard and identify improvement areas.'
                },
                {
                  step: 'Step 3',
                ...
                },
                {
                  ...
                  desc: 'We apply for the organization\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certification Audit Coordination',
                  desc: 'Coordinate with an independent certification body, support audit scheduling and help organize responses to audit findings. ISO itself does not issue certificates.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Common management-system standards include ISO 9001 for quality, ISO 14001 for environment, ISO 45001 for occupational health and safety, ISO 27001 for information security and ISO 22000 for food safety.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the organization structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our ISO advisors help you understand which standard fits your business and what practical documentation and evidence are needed.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After certification, organizations should continue operating the management system, complete planned internal audits, management reviews and corrective actions, and prepare for surveillance or recertification audits as applicable.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the organization\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered organization name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual organization Compliance & Tax Filing',
                  desc: 'File the organization\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                  title: 'Report Changes to the certification body',
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the organization employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on organization structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                ISO Certificate Validity & Audit Cycle
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              organization tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on organization Structure',
                  desc: 'Tax liability and exemptions depend on whether the organization is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible organizations must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working management representatives are taxable in the authorized representative\'s hands but deductible for the organization, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible organizations should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the organization structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Business Value of ISO Certification
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              organizations generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible organizations may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, organizations may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an organization; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
        ...
        <section id="why-akshayb2b" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Standard Selection & Initial Gap Review',
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your management representatives\' needs.'
                },
                {
                  title: 'Audit-Ready Documentation Support',
                  desc: 'Our specialists help prepare practical policies, procedures, registers and records aligned to your selected ISO standard.'
                },
                {
                  title: 'Certification Process Coordination',
                  desc: 'We help coordinate the external certification process and organize responses to documentation or audit findings.'
                },
                {
                  title: 'Structured Documentation Kit',
                  desc: 'Receive a structured documentation framework designed to make implementation and audit preparation easier.'
                },
                {
                  title: 'Post-Certification Guidance',
                  desc: 'Get guidance on maintaining the management system, preparing for surveillance audits and keeping key records current.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Clear professional assistance fee of ₹1,999 for the stated support scope. Independent certification-body or audit charges, if applicable, depend on the selected standard and scope.',
                  icon: Tag
                },
                {
                  title: 'Pan-India Business Support',
                  desc: 'Online assistance designed for Indian MSMEs, manufacturers, service providers, contractors and growing businesses across sectors.',
                  icon: Users
                },
                {
                  title: 'Audit Readiness Guidance',
                  desc: 'Get structured guidance for internal audits, management reviews, corrective actions and certification readiness.',
                  icon: Zap
                },
                {
